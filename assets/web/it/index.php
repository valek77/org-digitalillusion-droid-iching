...
';
$book['01']['judge'] = 
 'Il creativo opera sublime riuscita, propizio per perseveranza.\e
  La via del creativo si basa su trasformazioni durature che riescono nel tempo a dare forma e misura alle cose. ';
$book['01']['image'] = 
' Immagine Il moto del cielo è vigoroso.\e
  Cosi’ il nobile rende se stesso forte e instancabile. I due trigrammi raddoppiati indicano forza e instancabilità, così come ad ogni atto ne segue subito in altro, operando per dare forma armoniosa a ciò che si fa. ';
$book['01']['line1'] = 
' Nove all\'inizio significa:
  Drago coperto. Non agire.\e
  La possibilità di agire è limitata, ci sono aspetti sconosciuti e celati non ancora manifesti che si esprimeranno nel tempo. Fino ad allora non intervenire. Muta in 44 Farsi incontro ';
$book['01']['line2'] = 
' Nove al secondo posto significa:
  Drago che compare nel campo. Propizio è vedere il grande uomo. \e
  La situazione comincia a mostrare segni di sviluppo e chiari e instancabili si comincia ad operare passo dopo passo nell’impresa. Avvicinatevi a qualcuno di cui vi fidate ciecamente. Muta in 13 Associazione ';
$book['01']['line3'] = 
' Nove al terzo posto significa:
  Il nobile è creativamente attivo tutto il giorno. Ancora a sera è pieno di pensieri. Pericolo. Nessuna macchia.\e 
  Tutto sembra promettere bene, ci sono opportunità di diventare importanti e rispettati. Ma la vostra mente e il vostro cuore non sono puri, poiché affaticati dall’impegno che vi siete assunti. 
  Se saprete evitare il pericolo rappresentato dal fare troppo, non ci saranno danni. Moderatevi. Muta in 10 Procedere ';
$book['01']['line4'] = 
' Nove al quarto posto significa:
  Oscillante slancio al di sopra dell’abisso. Nessuna macchia. 
  L’impresa comporta qualche rischio, perché è un passo di notevole portata. C’è incertezza di direzione ma preservando le forze, senza perdere la calma e affrettare le cose, si evita il pericolo di strafare. 
  Lontano da tutti e in solitudine si deve avere il coraggio di definirsi da soli, edificando il proprio personale e unico cammino. Muta in 9 Forza domatrice del piccolo';
$book['01']['line5'] = 
' Nove al quinto posto significa:
  Drago volante nel cielo. Propizio è vedere il grande uomo.\e 
  Si è raggiunta una posizione di prestigio e integrità. Il nostro fare si alza schietto, giusto e puro, come fa il grande uomo. Muta in 14 Possesso grande ';
$book['01']['line6'] = 
' Nove sopra significa:
  Drago altezzoso avrà da pentirsi.\e 
  Non bisogna pensare alle cose che si intraprendono come a una sfida verso qualcuno o per ottenere qualcosa. Si vuole compiere qualcosa che ci porta troppo al di là del necessario. In tal caso sorge l’isolamento, poiché si vuole andare troppo in alto per chi non è in grado di seguirci. Siate più umili, altrimenti restate da soli. Muta in 43 Straripamento ';
$book['01']['line-3'] = 
' Quando tutte le linee sono nove significa:
  Ecco comparire uno stormo di draghi senza testa. Buona fortuna. \e
  Vincoli  che limitano l’agire sono caduti e non si è più costretti ad attenersi ad essi. 
  Muta  in 2- Ricettivo';
...
' Esagramma 2 – Il Ricettivo.
  ...
  Devi allontanarti da ciò che richiede sforzo e agitazione; rivolgiti a chi ti accoglie a braccia aperte e ti nutre. 
  Nel frattempo ascolta i tuoi reali bisogni, lancia uno sguardo nel tuo cuore e ritrova i tesori che hai dimenticato e trascurato.
  Tutto è in attesa di un cambiamento: lascia che il tempo compia il suo piano di lavoro, senza forzare l’esito; intanto resta ricettivo e accogli ogni esperienza come un aiuto verso la crescita, in un’attitudine incondizionata e serena a ricevere più che a dare. 
  Ricorda che ciò che ti spinge a reagire e fare non agevola la tua crescita e che questo momento di quiete e amore deve essere protetto; pensieri di lotta e sfide, tutti provenienti da disturbi e ostacoli interni ed esterni ti spingono verso obiettivi per ora immaturi ma che a tempo dovuto si risolveranno a pieno. ';
$book['02']['judge'] = 
' Il Ricettivo opera sublime riuscita, propizio per la perseveranza di una cavalla. Se il nobile ha qualcosa da imprendere e vuole precedere si smarrisce; se invece segue trova una guida. Propizio è trovare amici nell’Occidente e nel Meridione, rinunciare ad amici nell’Oriente e nel Settentrione. Tranquilla perseveranza reca salute.\e
  Ciò che ci sta a cuore può essere raggiunto solo con grande pazienza e calma.
  Volete qualcosa la cui realizzazione è ancora prematura; ogni tentativo, gli sforzi, le iniziative conducono a strade senza uscita. 
  Tutto ciò che si può fare è attendere l’iniziativa di un altro. Nel frattempo dedicatevi ad attività rilassanti che non vi richiedono sforzi fisici o mentali e frequentate chi vi dimostra amicizia e fiducia; rinunciate a chi vi causa sofferenza e sforzo ed è poco sensibile o ostile verso di voi. Una pausa tranquilla vi fa bene. Mettetevi in posizione di accoglienza e attendete pazientemente. ';
$book['02']['image'] = 
' Immagine Lo stato della terra è l’accogliente dedizione. Così il nobile sorregge con l’ampiezza della sua natura il mondo esterno.\e 
  La natura della terra è di accudire e seguire l’iniziativa del cielo. Così si accudisce ciò che ci sta a cuore e con generosità si aspetta che qualcuno o qualcosa ci venga incontro. ';
$book['02']['line1'] = 
' Sei all\'inizio significa:
  Quando si calpesta brina il ghiaccio sodo è vicino. Decadimento. \e
  I segni che si cominciano a intravedere ne sono le avvisaglie. Tuttavia la cosa persiste fino a manifestarsi di nuovo, senza grandi interventi da parte nostra. Muta in 24 Ritorno ';
$book['02']['line2'] = 
' Sei al secondo posto significa:
  Dritto, rettangolare, grande. Senza intenzione pur nulla rimane trascurato. \e
  La terra è dritta, retta e grande e queste qualità le incarni tutte: pazienza infinita, dedizione, lunghe pause in attesa della venuta dell’ispirazione; ma non forzare nulla. Quando poi hai perso le speranze, ecco che qualcosa comincia a muoversi. Muta in 7 Esercito ';
$book['02']['line3'] = 
' Sei al terzo posto significa:
  Linee celate; si è in grado di rimanere perseveranti. \e 
  Se sei al servizio di un re non ricercare opere, ma il compimento! Tutto si svolge dietro le quinte, in segreto. Continuerà così, come è giusto e bene che sia. 
  Ciò che ti sta a cuore deve arrivare alla sua conclusione, perciò non perderti in inutili ';
$book['02']['line4'] = 
' Sei al quarto posto significa:
  Sacco chiuso e legato. Non macchia, non lode. \e
  Isolamento, impossibilità di movimento. Non è un male. Muta in 16 Fervore ';
$book['02']['line5'] = 
' Sei al quinto posto significa:
  Sottoveste gialla reca sublime salute. \e
  Il giallo è il colore della terra, la sottoveste indica una intima dedizione all’impresa che ci sta a cuore, umiltà e passiva attesa, nonché pazienza, che deve operare in noi. 
  Grazie a questo atteggiamento di sottomissione seguirà un completo sviluppo positivo. Muta in 8 Solidarietà ';
$book['02']['line6'] = 
' Sei sopra significa:
  Sottoveste gialla reca sublime salute.\e 
  Il giallo è il colore della terra, la sottoveste indica una intima dedizione all’impresa che ci sta a cuore, umiltà e passiva attesa, nonché pazienza, che deve  operare in noi. 
  Grazie a questo atteggiamento di sottomissione seguirà un completo sviluppo positivo. Muta in 8 Solidarietà ';
$book['02']['line-3'] = 
' Quando tutte le linee sono sei significa:
  Propizia è durevole perseveranza. Non si avanza, ma neppure si retrocede. \e
  Mantenere la fiducia senza agire. 
  Nel tempo qualcosa avverrà, venendo a noi dall’esterno. 
  Muta in 1- Creativo
 ';
...
$book['03']['judge'] = 
' La difficoltà iniziale opera sublime riuscita, propizia per perseveranza. Non imprendere nulla. Propizio è nominare aiutanti.\e
  Tempi di crescita sono soggette a difficoltà. Assomigliano a un primo parto. Ma queste difficoltà derivano dalla profusione di tutto ciò che sta lottando per raggiungere la forma.
  Tutto è in movimento: dunque se uno persevera ci sarà una prospettiva di grande successo, nonostante il pericolo esistente. 
  Quando è il destino di un uomo di intraprendere tali nuovi inizi, tutto è ancora informe, oscuro. 
  Perciò egli deve trattenersi, perché ogni mossa prematura può portare disastro. Analogamente, è molto importante non rimanere solo, per superare il caos ha bisogno aiutanti. 
  Questo non vuol dire, tuttavia, che egli stesso non dovrebbe guardare passivamente a ciò che sta accadendo. Egli deve dare una mano e partecipare con ispirazione e guida.';
$book['03']['image'] = 
' Immagine Nuvole e tuono. L’immagine di difficoltà all’inizio. Così il nobile porta ordine nella confusione.\e
  Nel caos di difficoltà all’inizio, l’ordine è già implicito. Così anche l’uomo superiore deve predisporre e organizzare la profusione incipiente di questi tempi di inizio, proprio come si fa ordine in fili di seta da un groviglio annodato e li lega in matasse. Al fine di trovare il proprio posto nella infinità delle trame e dei percorsi, deve essere in grado sia di separare che di unire.
  All’esterno fare il minimo: un periodo di vuoto e di incomprensione ci aspetta. Ma dentro, nel profondo, tutto sta lottando per definirsi. Se qualcosa o qualcuno vuole aiutarci, ben venga: abbiamo bisogno di appoggio, ma non di condivisione, non ancora. Ciò che in passato è stato fatto ha bisogno di tempo per riorganizzarsi in qualcosa di nuovo. Non sarà senza pena e fatica, come ogni spirale di crescita. Attraversare questo passaggio importante con l’aiuto di chi è al nostro stesso livello ricettivo. ';
$book['03']['line1'] = 
' Nove all\'inizio significa: 
  Titubanza e impedimento. Propizio e rimanere perseveranti. Propizio è nominare aiutanti.\e
  Ostacoli, che impediscono di agire con decisione e personalmente. 
  Non abbandonare l’impresa, ci sono persone o situazioni che possono aiutare in questo inizio di costruzione. Muta in 8- La Solidarietà. 
 ';
$book['03']['line2'] = 
' Sei al secondo posto sigifica:
  Difficoltà si ammassano. Cavallo e carro si distaccano. Egli non è un brigante, a suo tempo si dichiarerà. La fanciulla è casta, non si promette. Dieci anni, poi si promette.\e
  Nei tempi di confusione il brigante viene scambiato per un re, e viceversa. In tale dubbio paralizzante è meglio aspettare prima di impegnarsi in alcunché. Solo alla fine di un intero ciclo di eventi si riconosce apertamente la natura della persona o della situazione che ci sta a cuore. Muta in 60- Limiti ';
$book['03']['line3'] = 
' Sei al terzo posto significa: 
  Chi caccia il servo senza guardiacaccia non fa che smarrirsi nel bosco. Il nobile comprende i segni del tempo e piuttosto rinuncia.\e
  Continuare ad agire reca umiliazione. Pur di ottenere un risultato ci si lancia in un’impresa alla cieca. 
  Così si perde la direzione e si resta intrappolati in illusorie speranze che ci allontanano sempre di più dal giusto cammino. 
  Rinunciare e ritirarsi è la cosa migliore da fare. Muta in 63- Dopo il compimento. ';
$book['03']['line4'] = 
' Sei al quarto posto significa: 
  Cavallo e carro si distaccano. Ricerca l’unione. Andare reca salute. Tutto opera in favore.\e
  Anche se la situazione è di distacco si può cercare di risolverla. Si hanno buone possibilità se si prende un’iniziativa. Muta in 17- Seguire. ';
$book['03']['line5'] = 
'Nove al quinto posto significa: 
 Difficoltà nel far prosperare. Piccola perseveranza reca salute, grande perseveranza reca sciagura. 
 Ciò che si desidera è a portata di mano, ma qualcosa causa un blocco e impedisce il compimento del desiderio.
 Le buone intenzioni vengono frustrate da incomprensioni. Ci sono figure che rivaleggiano e in antagonismo. 
 Non ci si può fare nulla, bisogna accontentarsi di quel poco che si ha e guardarsi da un’insistenza cieca. Muta in 24- Ritorno. 
';
$book['03']['line6'] = 
'Sei sopra significa: 
 Cavallo e carro si distaccano. Lacrime di sangue sgorgano. Soli, senza aiuto, senza supporto alcuno.\e
 Un periodo di estremo isolamento e dispiacere ci attende. Si rinuncia a districare l’impedimento, con amarezza. Muta in 42- Accrescimento. ';
...
'Esagramma 9 – Il potere del piccolo.
  Il cielo sta sotto il vento, il mite, che penetra dappertutto e persevera nella sua azione. 
  Ma il vento non è abbastanza forte per trasformare le nubi, presenti nel trigramma interno Lago. 
  Si descrive una situazione di attesa mentre si prepara un’ impresa con piccoli e persistenti aggiustamenti. ';
$book['09']['judge'] = 
' Sentenza La forza domatrice del piccolo ha riuscita. Dense nubi, nessuna pioggia dalle nostre contrade occidentali. \e
  L’azione penetrante e persistente, fatta dietro le quinte, ha successo. 
  Ci sono tante possibilità che possono avvenire, e si aspetta con ansia la loro comparsa; ma il tempo non è ancora venuto, ora ci si deve solo dedicare alla loro preparazione. 
  Si sta iniziando qualcosa che solo nel tempo darà il suo frutto.';
$book['09']['image'] = 
' Immagine Il vento soffia nel cielo: l’immagine della forza domatrice del piccolo. Così il nobile affina le forme esteriori della sua natura. \e
  Il vento con la sua mitezza smuove tutte le cose, anche se lo fa dietro le scene. 
  Così, dietro le quinte, internamente, restiamo fedeli e saldi ai nostri desideri e principi, mentre esternamente adottiamo la diplomazia, non esponendoci troppo apertamente. ';
$book['09']['line1'] = 
' Nove all\'inizio significa:
  Ritorno alla via. Come potrebbe questo essere una macchia! Salute!\e
  Un ritorno a qualcosa che abbiamo già fatto e che per noi è stata fonte di profondo nutrimento. 
  E’ una buona cosa tornare a ciò che si era lasciato in sospeso. Muta in 57 Vento ';
$book['09']['line2'] = 
' Nove al secondo posto significa:
  Si lascia indurre a ritornare. Salute! \e
  Tornare a ciò che avevamo lasciato ci rende più sicuri e costituisce un punto fermo nel nostro cammino. Muta in 37 Famiglia ';
$book['09']['line3'] = 
' Nove al terzo posto significa:
  Dal carro si staccano i raggi delle ruote. Marito e moglie stralunano gli occhi.\e
  Circostanze esteriori impediscono il progresso, ma non ci si rassegna. Nascono discussioni e asti. Muta in 61 Verità Interiore ';
$book['09']['line4'] = 
' Sei al quarto posto significa:
  Se sei verace svanisce il sangue e si allontana l’angoscia. Nessuna macchia. \e
  La situazione richiede scelte difficili che possono indurre altri ad irritarsi. 
  Ciò ci procura dubbi, ma se si riesce a mantenere la propria direttiva non vi saranno conseguenze nefaste, e saremo più sereni. Muta in 1 Creativo ';
$book['09']['line5'] = 
' Nove al quinto posto significa:
  Se sei unito in fedeltà e sincerità sei ricco nel tuo prossimo. \e
  L’unica vera ricchezza è la gioia di stare con chi ci completa; tutto ciò che si desidera si trova dove c’è fedeltà e sincerità reciproca. Muta in 26 Forza domatrice del grande ';
$book['09']['line6'] = 
' Nove sopra significa:
  Viene la pioggia, viene la quiete. Ciò è dovuto alla durevole azione del carattere. La moglie perseverando finisce in pericolo. La luna è quasi piena. Se il nobile persiste si ha sciagura. \e
  Finalmente si arriva al rilascio della tensione, con la venuta della pioggia. 
  Grazie al paziente lavorio siamo riusciti a conseguire ciò che ci sta a cuore. Ma qualcuno, invece di fermarsi e accontentarsi, vuole di più, e quindi va incontro a pericoli. 
  La luna ha completato quasi il suo corso, quindi si appresta già a calare. Accontentiamoci dunque di quello che abbiamo ottenuto e non insistiamo a volere di più, altrimenti ne verrà sciagura. Muta in 5 Attendere ';

# -------------------------      10       ----------------------- #
$book['10']['desc'] = 
' Esagramma 10 – Il Procedere
  Il Cielo sul Lago. Una linea yin procede tremante e spaventata in mezzo alle linee forti. Il suo andare è rischioso, mette alla prova la sua volontà: come può affrontare il grande sforzo che richiede l’impresa? 
  Essa è debole ma volenterosa, purtroppo spesso non ha la chiarezza necessaria per procedere senza farsi male e di comprendere le difficoltà che comporta l’impresa.
  Man mano che procede, però, essa comprende che dalle cose pericolose e troppo impegnative è bene tenersi a giusta distanza, e – attraverso delle giuste scelte – alla fine ha successo. 
  Il Lago simbolizza parole e discorsi che vengono utilizzati al fine di chiarire e risolvere con successo la situazione. 
  Si è in qualcosa di difficile ma che con le buone maniere e la giusta scelta si risolve appena in tempo.  ';
$book['10']['judge'] = 
' Procedere sulla coda della tigre. Se essa non morde l’uomo, riuscita.\e
  Ci si avventura in qualcosa di molto impegnativo, di pericoloso e forte che ci coinvolge profondamente. 
  Bisogna dargli il giusto peso, rinunciare a ciò che è al di là delle nostre forze e vi è riuscita. 
  La riuscita sta nel definire il ruolo di persone e cose per noi e di scegliere ciò che è veramente utile ed importante. ';
$book['10']['image'] = 
' Sopra il cielo, sotto il lago: l’immagine del procedere. Così il nobile distingue superiore e inferiore e consolida i sentimenti del popolo.\e
  Il lago, con la sua innocenza vuole salire al cielo che è forte e chiaro. 
  E’ un’impresa difficile, perchè il lago è la cosa più bassa e il suo cammino per raggiungere l’obiettivo richiede forza e chiarezza. 
  Se si distingue tra ciò che è basso, non destinato ad evolversi ed è da abbandonare – e ciò che è alto cioè costruttivo e va coltivato, ogni difficoltà si risolve. 
  In questo modo tutte le persone coinvolte sono contente perchè trovano il proprio ruolo nell’economia della situazione. ';
$book['10']['line1'] = 
' Nove all\'inizio significa:
  Procedere semplice. Progredire senza macchia. \e
  All’inizio di ogni cosa si procede con semplicità e si è da soli. Non forzare le cose a un cambiamento – continuare così non è un danno. Muta in 6 Lite ';
$book['10']['line2'] = 
' Nove al secondo posto significa:
  Procedere sulla via semplice, piana. La persevaranza di un uomo oscuro reca salute.\e
  Agite senza farvi troppe complicazioni, con sincerità e senza forzature. Siate semplici e sinceri. 
  C’è qualcuno che continua a starvi vicino, i suoi scopi non sono del tutto chiari, ma vi permette di svolgere meglio il compito, dandovi manforte. Muta in 25 Innocenza ';
$book['10']['line3'] = 
' Sei al terzo posto significa:
  Un orbo sa vedere, uno sciancato sa procedere. Egli procede sulla coda di una tigre. Questa morde l’uomo. Sciagura! \e
  Si è troppo sicuri di sé, si crede di sapere e di avere la capacità per gestire la situazione. 
  Ma non è così, ci stiamo spingendo oltre le nostre forze e ne affrontiamo le spiacevoli conseguenze. 
  Qui non bastano le buone intenzioni, quando manca la forza di mettere in atto ciò che si vuole. ';
$book['10']['line4'] = 
' Nove al quarto posto significa:
  Egli procede sulla coda della tigre. Prudenza e circospezione conducono infine alla salute.\e
  La situazione è difficile. Con molta attenzione bisogna agire, senza esagerare nel voler dire o fare troppo. 
  Senza strafare si ha uno sviluppo positivo. Muta in 61 Verità Interiore ';
$book['10']['line5'] = 
' Nove al quinto posto significa:
  Procedere deciso. Perseveranza con coscienza del pericolo.\e
  E’ il momento di agire con decisione. C’è sempre il pericolo che la situazione ci sfugga di mano ma dobbiamo e possiamo andare avanti. Muta in 38 Contrapposizione ';
$book['10']['line6'] = 
' Nove sopra significa:
 Guarda il tuo procedere ed esamina i segni favorevoli. Se tutto è compiuto viene sublime salute.\e
 E’ infine giunto il momento di osservare dove sei arrivato: ci sono i frutti? Controlla se hai lasciato ancora in sospeso qualcosa e metti a posto ogni dubbio. 
 Se non c’è nient’altro da fare l’impresa è compiuta perfettamente. Muta in 58 Serenità. ';
...
$book['11']['line1'] = 
' Nove all\'inizio significa:
  Svellendo la falaride si sradica la zolla erbosa. Ognuno secondo la propria specie. Imprese recano salute.\e
  Si vuole emendare un particolare attraverso una messa in discussione del generale. Le cose vanno distinte. 
  Si intervenga facendo attenzione a non coinvolgersi troppo con estranei. Muta in 46 Ascendere ';
$book['11']['line2'] = 
' Nove al secondo posto significa:
  Sostenere con mitezza gli incolti, attraversare decisi il fiume, non trascurare il distante, non tener conto dei compagni: così si riesce a camminare nel mezzo.\e
  Andare avanti decisi, con uno sguardo interessato agli altri, ma pur sempre da soli. 
  Qualcosa che viene visto da lontano, utilizzato ma non in prima persona. Si è colui che legge, non l’autore del messaggio. Muta in 36 Oscuramento della luce ';
$book['11']['line3'] = 
' Nove al terzo posto significa:
  Nessun piano cui non segua il declivio, nessuna andata cui non segua un ritorno. Senza macchia è chi rimane perseverante nel pericolo. Non rammaricarti di questa verità, godi della felicità che ancora possiedi. \e
  Alti e bassi, si va e si viene, ritorni e addii. Anche se bisogna sforzarsi per non reagire, è meglio accontentarsi a malincuore di questa situazione senza cercare di cambiarla. 
  Sono in arrivo anche preoccupazioni di altro tipo. Muta in 19 Avvicinamento ';
$book['11']['line4'] = 
' Sei al quarto posto significa:
  Egli scende volteggiando, senza rammaricarsi della ricchezza, insieme al suo prossimo, schietto e sincero. \e
  Amicizia disinteressata, generosità e conforto in arrivo. 
  Qualcuno si dimostra propenso a condividere con voi il cammino, con fiducia e serenità. Muta in 34 La potenza del grande ';
$book['11']['line5'] = 
' Sei al quinto posto significa:
  Il sovrano I da in sposa sua figlia. Questo reca prosperità e sublime salute.\e
  La linea è centrale perciò possiede l’esaudimento di tutti i desideri. 
  Viene concesso un grande dono, un onore, una importante vittoria o riconoscimento personale. Muta in 5 Attendere ';
$book['11']['line6'] = 
' Sei sopra significa:
  Il vallo ricade nel fossato. Adesso non impiegare eserciti. Nella tua propria città annuncia i tuoi ordini. Perseveranza reca umiliazione.\e
  Tentativi che non hanno l’effetto sperato. La cosa migliore è non insistere e non forzare le cose. 
  Metti ordine ed esercita la tua autorità nella tua cerchia più vicina; si può influenzare solo ciò che è vicino e certo, si va incontro a insuccesso se si cerca di agire diversamente. 
  Muta in 26 Forza domatrice del grande ';
$book['11']['line-3'] = '
 Quando tutte le linee mutano significa:
 Declino e stasi caratterizzano l’andare, l’attività si ritira nonostante i nostri sforzi. 
 Nulla si può fare per modificare una situazione fortemente compromessa. 
 Muta in 12- Ristagno';
...
$book['12']['line-3'] = 
' Quando tutte le linee mutano significa:
  Il Cielo sotto e la Terra sopra, le cause del ristagno si sciolgono, si apre la via dell’azione retta e della prosperità. 
  Muta in 11 - La Pace';
...
' Esagramma 24: Il Ritorno (Il Tempo del Volgimento) 
  ...
  La luce torna sempre dopo l’oscurità, dando origine a nuove fioriture.  
  La situazione riguarda qualcosa che va e viene ciclicamente; non si è nuovi a questi momenti. 
  E’ un tempo in cui si fanno piani e in cui si definiscono nuove idee e basi di crescita. 
  Se si pensa alla possibilità di agire, agite.';
$book['24']['judge'] = 
' Il ritorno. Riuscita. Uscita ed entrata senza errore. Amici vengono senza macchia. Serpeggiante è la via. Al settimo giorno viene il ritorno. E’ propizio avere ove recarsi.\e
  Ritorno della luce e quindi riuscita e sblocco dell’inattività. 
  Qualcuno che non conosciamo  porta novità e aiuta a prendere nuove vie, nuove risoluzioni; si presentano scelte e possibilità, e c’è lunga ponderazione sul da farsi. 
  Alla fine, anche se passerà un po’ di tempo, però ci sarà lo sblocco e si può cominciare a muoversi, andando verso una meta precisa.';
$book['24']['image'] = 
' Il tuono dentro la terra: l’immagine della svolta. Così gli antichi re al tempo del solstizio chiudevano i valichi. Mercanti e stranieri non viaggiavano, e il sovrano non visitava le contrade.\e
  L’Eccitante, il Tuono, la forza vitale apportatrice di energia, si trova nel tranquillo e accogliente  grembo materno. 
  Nel mondo umano ciò avviene quando ogni attività precedente si conclude e si comincia  da capo rinnovati. 
  Gli antichi e saggi re impedivano il passaggio degli estranei, per lasciare indisturbata la terra. 
  Loro stessi si ritiravano senza interferire. 
  E’ dunque  un momento di speranza e rigenerazione, prima di cominciare una nuova fioritura.';
$book['24']['line1'] = 
' Nove all\'inizio significa:
  Ritorno da piccola distanza. Non vi è bisogno di alcun pentimento. Grande salute! \e
  E’ l’unica linea attiva della serpeggiante via del Ritorno.
  Se c’è stato un allontanamento è stato per breve tempo; la distanza tra voi non è grande; se c’è una persona o una situazione che è già molto vicina a noi, anche materialmente, gli si  rivolge attenzione e cura. Sono gli altri che vengono a noi, cercando contatto. 
  Per noi nulla di male. 
  Muta in 2- Ricettivo: il grembo in cui si sviluppano le cose.';
$book['24']['line2'] = 
' Sei al secondo posto significa:
  Ritorno tranquillo. Salute. \e
  La situazione procede a  piccoli passi, in sottofondo. 
  Nessun bisogno di decidere o preoccuparsi.
  Si procede bene.  
  Muta in 19- Avvicinamento';
$book['24']['line3'] = 
' Sei al terzo posto significa:
  Ritorno molteplice. Pericolo. Nessuna macchia. \e
  La via diventa serpeggiante, l’attività della prima linea comincia ad allontanarsi. 
  Troppe persone implicate nella situazione, troppi eventi insieme cominciano a generare qualche preoccupazione. 
  Così incalzati da altri coinvolti si finisce nel pericolo e nella confusione; nonostante il nostro riserbo, i disturbi continuano, senza partecipazione attiva da parte nostra. 
  Qualcuno continua a disturbarci, è già successo e succederà ancora, non per motivi imputabili a noi.  
  Muta in 36- Ottenebramento della Luce.';
$book['24']['line4'] = 
' Sei al quarto posto significa:
  Camminando in mezzo agli altri si ritorna soli. \e
  Se la linea continua insieme alle altre va incontro al blocco; meglio allora tornare indietro, verso la luce della prima linea yang. 
  Così abbandona il gruppo e torna indietro da sola. 
  Sebbene non si parli di premio né di punizione, questo ritorno è assai propizio. 
  La scelta così risoluta a favore del bene, ha in sé il suo premio. dice Wilhelm. 
  Si è coinvolti con persone che non aiutano a crescere, e  che alla fine si dovranno abbandonare per tornare indietro. 
  La situazione è di qualcuno coinvolto in qualcosa di inconsistente  e che comincia a nutrire dei dubbi se continuare o no. 
  Infine  prende la decisione di dedicarsi alle proprie reali necessità.
  Muta in 51- Tuono';
$book['24']['line5'] = 
' Sei al quinto posto significa:
  Ritorno magnanimo. Nessun pentimento. \e
  Anche se non si è legati da vincoli o necessità, si decide volontariamente di intraprendere un’attività. 
  Questa generosità non è un errore.  
  Muta in 3 Difficoltà iniziale';
$book['24']['line6'] = 
' Sei sopra significa:
  Ritorno fallito. Sciagura. Disgrazia da fuori e da dentro. Facendo marciare gli eserciti in questo modo, si subirà infine una grande sconfitta, cosa sciagurata per il principe regnante. Per dieci anni non si è più in grado di portare attacco.\e
  Il ciclo si è concluso, la possibilità di mutare svanita. 
  Bisognerà aspettare che un nuova svolta riemerga, dal basso. 
  Andare avanti così, ottusamente e prendendo decisioni a casaccio comporta il fallimento per noi e disgrazia per qualcuno che ci sta a cuore. 
  Le conseguenze della nostra condotta erronea saranno un peso per molto tempo. 
  Muta in 27- Nutrimento';
...
' Esagramma 25 – L\'Innocenza
  ...
  Il segno intrinseco Monte implica un arresto, Vento la tendenza insistente delle nostre aspirazioni. 
  Ci sono tutte le intenzioni di compiere un rinnovamento, di gettarsi alle spalle il passato e cominciare a nutrire senza artifici qualcosa che ci sta a cuore. 
  Ma se il movimento interiore, l’intenzione e la volontà che aspirano alla guarigione e alla rinascita ci sono, esternamente sono presenti situazioni o persone che intralciano il cammino. 
  La struttura si regge sulla prima linea, la più innocente di tutte, che vuole farsi strada ed elevarsi, sollevandosi dal ristagno, allontanandosi dalla ‘mala gente’ da cui finora era circondato. 
  Bisogna agire  per allontanarsi da persone e cose per noi fonte di profondo disagio, rinunciando anche a un qualche presunto vantaggio che possiamo ';
$book['25']['judge'] = 
' L’innocenza. Sublime riuscita. Propizia è perseveranza. Se qualcuno non è retto ha disgrazia e non è propizio imprendere qualche cosa.\e
  In questa impresa bisogna restaurare l’innocenza perduta e adottare un comportamento di sincerità e integrità; in questo modo la sublime riuscita è assicurata. 
  Per conseguirla bisogna fare scelte e allontanarsi da persone o situazioni  che ostacolano la riuscita. 
  Verso queste persone non è necessario fare nulla, solo lasciarle cadere continuando per la strada scelta, quella forte e chiara, fonte di soddisfazioni.';
$book['25']['image'] = 
' Sotto il cielo passa il tuono: tutte le cose acquistano lo stato naturale dell’innocenza. Così gli antichi re curavano e nutrivano, ricchi di virtù e in armonia con il tempo, tutti gli esseri.\e
 Quando il Tuono scoppia nel Cielo questo lo accoglie, lo amplifica e lo diffonde, così come la natura in primavera viene vivificata in una nuova esistenza.
 Nel mondo umano si è capaci di offrire le proprie cure e le proprie risorse a qualcosa, con umiltà e disinteressatamente. 
 Al momento giusto, le nostre azioni  porteranno beneficio a tutti.';
$book['25']['line1'] = 
' Nove all\'inizio significa:
  Condotta innocente reca salute!  \e
  Si è in contatto con situazioni controverse, fonte di preoccupazione. 
  Ce ne vogliamo separare e allontanarci dalla causa di disturbo; alla fine ci riusciamo.  
  Muta in 12 Ristagno : mala gente non è propizia alla perseveranza del nobile. 
  Attenzione a chi si frequenta.';
$book['25']['line2'] = 
' Sei al secondo posto significa:
  Se arando non si pensa al raccolto e dissodando all’uso del campo, allora è propizio imprendere qualche cosa.
  Sei a un bivio: o agisci per ottenere fama e prestigio, seguendo chissà quali fantasie- o decidi di dedicarti all’impresa seriamente. 
  Ciò significa impegno e studio, umile costruzione su basi  solide, stabili e accertate. 
  Bisogna dedicarsi a questa impresa sapendo che non vi sarà riconoscimento immediato.  
  Solo in questo caso ciò che si intraprende ha senso. 
  Muta in 10 Procedere';
$book['25']['line3'] = 
' Sei al terzo posto significa:
  Disgrazia immeritata: la mucca legata da qualcuno allo steccato è il guadagno del viandante, la perdita del proprietario. \e
  Perdita e guadagno: la linea è sola, quello che porta è preso da altri, che se ne giovano. 
  Le nostre buone intenzioni non sono consone al tempo e al luogo, e si commette un errore a continuare.
  A causa della nostra ingenuità e fiducia, qualcuno può approfittarne; si perde qualcosa che viene invece ottenuto da altri, che prendono e se ne vanno.
  Muta in 13 Associazione';
$book['25']['line4'] = 
' Nove al quarto posto significa:
  Chi è in grado di essere perseverante rimane senza macchia. \e
  Nonostante le difficoltà  occorre perseverare e non cambiare strada. 
  Anche se vi sono dubbi e si è stanchi con il tempo e la pazienza qualcosa può svilupparsi.  
  Muta in 42 Accrescimento.';
$book['25']['line5'] = 
' Nove al quinto posto significa:
  In caso di malattia senza colpa non adoperare farmaci. Passerà da sé. \e
  Ci si addossa responsabilità che non ci appartengono. Si è sottoposti a uno stress, una pressione, un’influenza negativa.
  Non è nel nostro potere e neppure un  dovere risolvere questa situazione, di cui non abbiamo colpa. 
  Se trattate  senza allarmarvi le difficoltà, si risolvono da sole.
  Muta in 21 Morso che spezza';
$book['25']['line6'] = 
' Nove sopra significa:
  Agire innocente reca disgrazia. Nulla è propizio. \e 
  Il tempo per agire con innocenza è finito. 
  Si è  legati al proprio mondo e alle proprie convinzioni: si agisce non  più con innocenza ma con leggerezza. 
  Muta in 17 Seguire';
...
' Esagramma 26: La Forza Fomatrice del Grande
  ...
  La chiave è il tempo, in cui ci si prepara per imprese anche pericolose e difficili';
$book['26']['judge'] = 
' La forza domatrice del grande. Propizia è perseveranza. Non mangiare a casa reca salute. Propizio è attraversare la grande acqua.\e
  Con la forza delle nostre azioni possiamo avvicinarci, se perseveriamo, a ciò che ci sta a cuore. 
  E’ una cosa buona impegnarsi all’esterno e attingere a stimoli diversi dal solito. 
  Si può procedere nell’impresa, che sarà impegnativa. 
  Propizio partire e allontanarsi dall’usuale corso delle cose.';
$book['26']['image'] = 
' Il cielo dentro il monte: l’immagine della forza domatrice del grande. 
  Così il nobile impara i detti dell’antichità e le gesta del passato per rafforzare le sue parole e le sue azioni.
  Ciò in cui avete sempre creduto ora potete metterlo in pratica, facendovi forza su ciò che è stato detto e fatto nel passato.  
  Fate tesoro delle esperienze acquisite e utilizzatele per essere più precisi e chiari sia nel parlare, o scrivere, sia nell’agire. 
  Riprendere in mano alcune idee del passato, importanti e finora accantonate e rielaborarle, esprimerle e metterle in pratica.  
  Domare le cose per migliorarle, ordinarle e piano piano attuarle.';
$book['26']['line1'] = 
' Nove all\'inizio significa:
  Vi è pericolo. E’ propizio desistere.\e
  Un ostacolo impedisce il passaggio, e anche dentro di noi vi sono dubbi. 
  Meglio aspettare che le cose si chiariscano meglio. 
  Muta in 18 Emendamento delle cose guaste';
$book['26']['line2'] = 
' Nove al secondo posto significa:
  Al carro vengono tolti gli assali. \e
  Un forte ostacolo impedisce il cammino; vi è un blocco e si deve attendere senza fare altro. 
  Muta in 22 Grazia';
$book['26']['line3'] = 
' Nove al terzo posto significa. 
  Un buon cavallo che ne segue altri. Propizie consapevolezza del pericolo e perseveranza. Ogni giorno esercitati nel guidare il carro e nel proteggerti con le armi. Propizio è avere ove recarsi.  \e
  Seguiamo una strada già percorsa prima di noi da altri. 
  Bisogna fiduciosamente seguire il loro esempio che può esserci di guida e sostegno in questa situazione. 
  Tuttavia è bene stare attenti costantemente agli errori che si possono compiere. 
  Bisogna concentrarsi su due cose: continuare ad agire per ciò che ci sta a cuore, lavorando per metterlo in pratica concretamente e stare in guardia da chi ti  nocivo e cerca di fermarci per contrastare i nostri piani.  
  Si possono cominciare nuove imprese al fine di ottenere ciò che ci sta a cuore. 
  Muta in 41 Diminuzione';
$book['26']['line4'] = 
' Sei al quarto posto significa:
  Il finimento frontale di un torello. Grande salute! \e
  Si previene uno scontro usando la gentilezza. 
  Ostacoli cadono grazie alla sincerità e  all’affetto. 
  Muta in 14 Possesso grande';
$book['26']['line5'] = 
' Sei al quinto posto significa:
  Il dente di un cinghiale castrato. Salute! \e
  La situazione non è brutta come sembra. 
  Un grande spavento o un dilemma si sciolgono spontaneamente. 
  Muta in 9 Forza domatrice del Piccolo';
$book['26']['line6'] = 
' Nove sopra significa:
  Si ottiene la via celeste. Salute! \e
  Si giunge alla meta per cui si è molto lavorato. 
...
' Esagramma 27: Il Nutrimento
  ...
  Quando vengono tenute ferme le cose, allora vi è nutrimento. 
  Le cose, dunque si devono fermare, e nel frattempo passate al vaglio di una osservazione e  una autocritica sulla natura di ciò che diciamo e facciamo. 
  C’è tanto, troppo: molte aspettative e illusioni che portano a deviare dalla via che nutre davvero in profondità.  
  Il responso generale non è di successo o sciagura, ma descrive un momento in cui è necessario moderarsi e non strafare, né materialmente né con le parole. 
  La stessa cosa dovrebbe essere applicata anche nei confronti degli  altri: osservare di cosa qualcuno si nutre, cioè  cosa dice o fa, ci mette in grado di comprendere meglio la sua natura e la nostra posizione  nei suoi confronti. 
  Ci si stacca dal molto detto o fatto nel passato, quando si scopre ciò che nutre davvero.';
$book['27']['judge'] = 
' Gli angoli della bocca. Perseveranza reca salute. \e
  Guarda al sostentamento e a ciò con cui un uomo cerca egli stesso di riempirsi la bocca. 
  Bisogna sì continuare a nutrirsi e percorrere la strada su cui siamo ma nella giusta dose. 
  Spesso si fanno e si dicono cose superflue o futili, di cui molto è da scartare, solo qualcosa è da mantenere. 
  Se qualcosa ci nutre davvero bisogna preservarla dal diventare futile dicendo troppo di essa o riempendocene troppo, agendo in modo sbagliato. 
  Gli altri inoltre possono non avere il nostro stesso modo di nutrirsi e avere altre preferenze. 
  Questo atteggiamento di prudenza nel dire e nel fare deve essere esercitato a lungo e con pazienza, in modo da scoprire e capire che cosa e chi si vuole alimentare.';
$book['27']['image'] = 
' Ai piedi del monte vi è il tuono: l’immagine del sostentamento. 
  Così il nobile sta attento alle sue parole ed è moderato nel mangiare e nel bere.\e
  Il tuono la cui natura è salire verso l’alto incontra il limite del monte. 
  Così ciò che nutre, sia materialmente che in forma di parole, ha un limite che non si deve superare. 
  Meglio attenersi al poco, modesto contributo che si può dare piuttosto che strafare.';
$book['27']['line1'] = 
' Nove all\'inizio significa:
  Tu lasci andare la tua tartaruga magica e mi guardi con gli angoli della bocca cadenti! Sciagura! \e
  Se stai cercando del nutrimento, lo stai facendo nel posto sbagliato. 
  Hai già tutto ciò che ti serve ma lo cerchi da altri che non possono darti nulla. 
  Stai cedendo alla debolezza, abbracciando strade che non dovresti percorrere e che non danno il frutto sperato. 
  Muta in 23  Scissione';
$book['27']['line2'] = 
' Sei al secondo posto significa:
  Nutrimento sul picco della montagna. 
  Deviare dalla via per cercare nutrimento dal colle: se si continua così, sciagura. 
  Sul picco della montagna non c’è nessuno, perché è un luogo isolato e difficile in cui vivere; eppure è proprio lì che devi stare per nutrire te stesso e gli altri.  
  Se cerchi di scendere a un livello diverso, più basso, si avvicinano situazioni e persone non adatte a te. 
  Conta sulla qualità e non sulla quantità. 
  Muta in 41 Diminuzione';
$book['27']['line3'] = 
' Sei al terzo posto significa:
  Egli è deciso a rinunciare al cibo. Disgrazia! \e
  Per dieci anni svolgerà mansioni inutili e non avrà luogo dove recarsi. 
  Se si agisce in questa circostanza, ci si allontana dalla retta via per seguire cose fuggevoli e riprovevoli che lasciano una intricata scia di conseguenze. 
  Dopodiché si resta intrappolati in situazioni che non apportano beneficio e sfociano in un nulla di fatto. 
  Muta in 22  Avvenenza';
$book['27']['line4'] = 
' Sei al quarto posto significa:
  Volgersi verso la vetta per nutrirsi reca salute. Scrutare in giro con occhi attenti come una tigre in brama insaziabile. Nessuna macchia.\e
  Si è in contatto con qualcosa che arricchisce  e a cui affidarsi; distinguerla attentamente, coltivarla e darle cura è della massima importanza. 
  Muta in 21 Il Morso che Spezza';
$book['27']['line5'] = 
' Sei al quinto posto significa:
  Deviare dalla via. Dimorare in perseveranza reca salute. Non bisogna attraversare la grande acqua. Fortuna a chi resta dove si trova. \e
  Non intraprendere niente. 
  Coltiva ciò che hai già ora e apprendi il modo per accrescerlo. 
  Non seguire altre iniziative.  
  Muta in 42 Accrescimento ';
$book['27']['line6'] = 
' Nove sopra significa:
  La sorgente del sostentamento. Consapevolezza del pericolo reca salute. Propizio è attraversare la grande acqua. \e
  Ciò che ci sta a cuore comporta grandi responsabilità e ci è molto vicino. 
  Si corrono dei rischi, per cui non tutto è facile e scontato. 
  Soltanto con questa consapevolezza ben chiara in mente si può compiere la grande impresa. 
  Muta in 24 Ritorno ';
...
$book['28']['judge'] = 
' La preponderanza del grande. La trave maestra si piega. Propizio è avere ove recarsi. Riuscita.\e
  La situazione è troppo carica e piena e sta per esplodere. Non se ne può più. 
  Prendere provvedimenti in modo da salvaguardarsi reagendo è una misura straordinaria ma saggia. 
  Si deve dunque abbandonare qualcuno o qualcosa che ci disturba e non è al nostro livello recettivo. 
  Dopo aver compiuto questo passo straordinario, le cose si calmano.';
$book['28']['image'] = 
' Il Lago oltrepassa gli alberi: l’immagine della preponderanza del grande.\e
  Così il nobile quando sta solo è libero da crucci e quando deve rinunciare al mondo è intrepido. 
  Il momento è simile a quando un’inondazione  raggiunge le cime più alte degli alberi, così come quando si è sommersi in qualcosa  che ha preso troppo spazio. 
  Il Trigramma Vento indica un albero solitario saldo al suolo e resistente, nonostante sia esposto ai venti e alle acque. 
  Il Trigramma Lago indica la spensieratezza e la serenità che si acquisisce con la rinuncia. 
  L’atteggiamento da tenere in questa situazione è di allontanarsi da qualcosa che è solo un problema anche se ciò ci farà sentire un po’ isolati.';
$book['28']['line1'] = 
' Sei all\'inizio significa:
  Poggiare su stuoia di canna bianca. Nessuna macchia.\e 
  Riflessione ed estrema prudenza, come se si volesse poggiare un oggetto fragile  e delicato su un piano morbido. 
  Muta in 43 Straripamento';
$book['28']['line2'] = 
' Nove al secondo posto significa:
  Un pioppo secco getta germoglio di radice. Un uomo anziano prende una moglie giovane. Tutto è propizio.\e
  Qualcosa che si sta spegnendo vuole riprendere vita, rinnovandosi in senso positivo. 
  Muta in 31 Stimolazione';
$book['28']['line3'] = 
' Nove al terzo posto significa:
  La trave maestra si piega. Sciagura.\e
  Ci stiamo spingendo al di là delle nostre attuali possibilità e non c’è rispondenza da parte di chi può aiutarci a sostenere il peso della situazione. 
  La nostra non è che ostinazione verso qualcosa di insostenibile.  
  Muta in 47 Oppressione';
$book['28']['line4'] = 
' Nove al quarto posto significa:
  La trave maestra viene sostenuta. Salute. Se vi sono secondi fini è vergognoso.\e
  La situazione è difficile ma non c’è un pericolo immediato di un crollo. 
  Quando però si perseguono scopi illeciti, cioè di bassa lega e minori, si va incontro all’ umiliazione. 
  Non fatevi impietosire e mettete ordine nella vostra vita. 
  Muta in 48 Pozzo';
$book['28']['line5'] = 
' Nove al quinto posto significa:
  Un pioppo rinsecchito getta boccioli. Una donna anziana trova marito. Nessuna macchia nessuna lode.\e
  Una situazione che si è spenta rifiorisce. 
  Si trova una certa concordia con qualcuno, ma di seconda mano, di cui accontentarsi.  
  Muta in 32 Durata';
$book['28']['line6'] = 
' Sei sopra significa:
  Bisogna attraversare l’acqua. Essa oltrepassa la testa. Sciagura. Nessuna macchia.\e
  L’impresa che si vuole compiere richiede un prezzo alto, che ci farà perdere più che guadagnare. 
  Ma quando si è in una situazione di sovrabbondanza asfissiante si deve cercare in tutti i modi di uscirne. 
  Anche così facendo le cose non si risolvono definitivamente. 
...
' Esagramma 29 : L’ Abissale.
  ...
  L’uscita di questo esagramma presagisce sempre uno di quegli avvenimenti destinati a incidere emozionalmente sulla nostra vita futura. 
  Non importa ciò che decidiamo di fare, che via seguiamo: è una svolta, un grande rimescolamento, un movimento degli opposti. 
  Avviene interiormente, più che fuori di noi: riguarda il modo in cui ci predisponiamo all’ignoto fluire del destino, che non possiamo modificare con nessun atto, ma solo ora abbandonarci ad esso. 
  La flessibilità dell’acqua su acqua che a tutto si adatta, persino allo sprofondamento in abissi pericolosissimi qui deve essere assecondata. E lo facciamo con il cuore: ‘se sei verace hai riuscita nel cuore’.
  Questo è il tempo di distruggere le dighe e lasciare che la marea sommerga tutto, è il tempo di annegare in ondate oceaniche per poi ritrovarsi, come naufraghi, su spiagge ripulite e terse, insieme a ossa di balena e conchiglie spiaggiate. 
  Non trattenere né trattenersi, seguire il Cuore. 
  Che ci parla molto sottovoce, piccola sorgente sotterranea che mai inaridisce, nonostante il chiasso mentale di cui di solito la ricopriamo. 
  La vita è movimento, la mente è movimento, come l’acqua: vie non ce ne sono più, scie profonde che crediamo di seguire si richiudono dietro di noi con beffarda ironia e noi ci troviamo a nuotare nella corrente senza direzione certa; eppure se ci si abbandona alla corrente con fiducia, l’acqua lava via quello che deve essere lavato. 
  Non dobbiamo toccare nulla, ma lasciar fare. 
  Solo il Cuore è capace di questo supremo atto di coraggio: lasciar fare. E lasciar essere. 
  Qualunque atto compiamo esteriormente, dobbiamo predisporci ad esso come a un passaggio mutevole  e difficoltoso tra i marosi, in cui nulla è per ora certo.
  Ma solo attraverso questo percorso arduo, che non durerà per sempre, ma che va affrontato, si sale di un gradino.
  Tempo difficile questo dell’Abissale. La notte oscura dell’anima. 
  Ma chi resiste senza respirare alla fine riemerge lavato e ripulito dalle scorie e i pesi tremendi (giacchè l’uscita di questo esagramma presuppone grande difficoltà interiore),e può insegnare agli altri. Non perché sa qualcosa, ma perché ha concepito nuova vita. 
  Il Mutamento in tutta la sua terrificante e crudele forza bruta, a cui solo chi si abbandona totalmente  può sopravvivere. Soffrirete. Morirete. 
  Per rinascere, è certo. C
  hi sarete, dopo la traversata? Non si sa, ed è nel non sapere che è la soluzione. 
  Assecondate gli impulsi del cuore, non date retta ai ragionamenti e a soppesare i passi da fare; fatevi guidare dalla sottile corrente del Cuore, datevi tempo, dominate l’impulso di opporvi, decidere, credere in facili soluzioni. 
  Andate, fate ma sapendo questo: non è che un passaggio, da cui però può ricominciare un viaggio che finora non sapevate di stare compiendo, e che vi donerà chiarezza e nuova vita. 
  Sarete diversi da ora, forse dolorosamente estranei anche a voi stessi. 
  E alla fine sarete in grado di dire: ho visto l’abisso e ne sono uscito. 
  E con questa saggezza dolorosamente acquisita  in cui avrete sacrificato parti di voi, sbloccherete l’impasse in cui siete ora.
  Dice Jean Jeaures: ‘Non si insegna quello che si sa o che si crede di sapere, si insegna soltanto quello che si è’.
  Non importa cosa fate e o cosa dite, importa solo l’attitudine interiore con cui vi apprestate a farlo.
  Annegate e poi vivete.';
$book['29']['judge'] = 
' L’Abissale ripetuto. Se sei verace hai riuscita nel cuore e ciò che fai incontra successo. \e
 Acqua sopra e acqua sotto rappresentano doppio pericolo: quello di indugiare troppo in una situazione senza decidersi a portarla a termine e quello di assuefarsi a questa indecisione di fondo. 
 Bisogna prendere la decisione di andare in profondità per portare a termine un cambiamento radicale nel nostro modo di vita, e allora vi è successo.';
$book['29']['image'] = 
' L’acqua scorre ininterrottamente e arriva alla meta: l’immagine dell’abissale ripetuto. 
  ...
  L’acqua  cade verso il basso fino a che non arriva al fondo di tutto, la sua meta, come la pioggia  continua a scrosciare dal cielo fino a tornare nelle pieghe della terra. 
  In questa situazione il nobile si comporta come l’acqua: penetra in tutti i risvolti e indaga fino in fondo evitando pericoli e insidie, continuando con costanza e fede il percorso, insegnando con il proprio esempio e la propria coerenza anche agli altri.';
$book['29']['line1'] = 
' Sei all\'inizio significa:
  Ripetizione dell’abissale. Nell’abisso si finisce in una buca. Sciagura. \e
  La situazione è difficile e persiste da tempo: ci siamo abituati e assuefatti a questo stato di pericolo. 
  Si è perduta la retta via e non se ne ha forza per uscirne. 
  Il risultato di tale procedere è infausto. Muta in 60 Limiti';
$book['29']['line2'] = 
' Nove al secondo posto significa:
  Nell’abisso vi è pericolo. Bisogna tendere solo a piccole cose.\e
  La  situazione è ardua e se ne vorrebbe uscire, liberandosene, ma un totale distacco da ciò che causa ansie e disturbi non è possibile. 
  Bisogna accontentarsi di allontanarsi quel tanto che basta, prendendo le distanze con piccoli gesti e aggiustamenti.  
  Muta in 8 Solidarietà';
$book['29']['line3'] = 
' Sei al terzo posto significa:
  Avanti e indietro, abisso sopra abisso. In tale pericolo fermati per ora, altrimenti nell’abisso finisci in una buca. Non agire così.\e
  Dovunque ci si volti, c’è il pericolo e una grande inquietudine ci accompagna. Si vorrebbe uscirne, ma a chi rivolgersi? 
  Si è soli ed incompresi,  ma bisogna sopportare un periodo di forzata inattività piuttosto che intraprendere iniziative ancora peggiori. 
  Tutte le vie di fuga ci sono precluse, e per quanto sia penoso rimanere a subire tale stato di cose, si deve sopportare la tensione, attraverso i turbamenti e le esitazioni del momento. 
  Muta in 48 Pozzo';
$book['29']['line4'] = 
' Sei al quarto posto significa:
  Una brocca di vino, una ciotola di riso come aggiunta, vasellame d’argilla, offerti semplicemente attraverso la finestra. 
  Ciò non costituisce alcuna macchia. 
  Piccole cose, modesti gesti di simpatia  vengono offerti. 
  Nulla di eclatante, ma sono i soli piccoli doni che possono provenire dall’esterno. 
  Questo è tutto ciò che ha da offrire la situazione in cui ci troviamo. 
  Si può contare solo su modeste presenze distanti.  
  Muta in 47 Assillo';
$book['29']['line5'] = 
' Nove al quinto posto significa:
  L’abisso non viene fatto traboccare, viene riempito solo fino all’orlo. Nessuna macchia.\e
  Guasti e pericoli sono presenti ancora ma almeno non se ne aggiungono altri.
  Se c’è volontà di costruzione, che muoia ciò che è eccessivo e pericoloso.
  Non esagerare e fare più di quanto il momento permetta. 
  Moderazione. 
  Muta in 7 Esercito';
$book['29']['line6'] = 
' Sei sopra significa:
  Legato con corde e funi, rinchiuso tra mura carcerarie irte di spine: per tre anni non ci si orienta. Sciagura! \e
  Una situazione di perdurante difficoltà vi imprigiona. 
  A lungo si cerca di trovare una via d’uscita. 
  Muta in 59 Dissoluzione ';

# -------------------------      30       ----------------------- #
$book['30']['desc'] = 
' Esagramma 30 – Il Fuoco
  Fuoco su fuoco, il raddoppiamento della chiarezza. 
  Essa fa luce e rischiara la natura delle cose e persone, donandoci la comprensione. 
  Come il fuoco è dipendente dalla legna su cui arde, così è bene continuare a nutrire il desiderio di far luce e comprendere per dissolvere le ombre. ';
$book['30']['judge'] = 
' L’aderente. Propizia è perseveranza. Essa reca riuscita. La cura della vacca reca salute. \e
  Il Fuoco aderisce alle cose illuminandole. 
  Bisogna continuare a fare chiarezza e in seguito vi sarà riuscita. 
  La vacca è rappresentata nei due segni yin quasi accuditi dalle forti linee yang, che le tengono a bada. 
  Così curare la vacca significa persistere e pazientare, essere flessibili e docili, nel frattempo che si continua a fare chiarezza. 
  E’ una situazione che descrive un lungo e tranquillo rischiaramento di qualcosa ancora di irrisolto. ';
$book['30']['image'] = 
' Il chiarore sorge due volte: l’immagine del fuoco. Così il grande uomo continuando questo chiarore, illumina le quattro regioni del mondo.\e
  Il Fuoco su un Fuoco, una luce doppia e persistente che illumina l’oscurità. 
  Così nel mondo umano si rischiarano le oscurità e ciò che è aspro e difficile, in una continua attività illuminante. 
  Bisogna continuare a scacciare ciò che è causa di malessere in modo continuo e persistente, per portare completa luce in ogni aspetto della nostra vita.
  Il Fuoco nel trigramma inferiore è rappresentato al suo primo apparire, esitante e incerto, nel suo ergersi scoppiettante e foriero di sviluppo, nel suo lento estinguersi; nel trigramma superiore  nel repentino riattizzarsi  in alte fiammate che culminano in solitari lampi. 
  Fu Hsi secondo la mitologia di IChing vide i segni di questo esagramma ed ebbe l’idea di costruire una rete per catturare i pesci. 
  Il simbolo è associato ad un’attività illuminante su ciò che è sfuggente da comprendere. ';
$book['30']['line1'] = 
' Nove all\'inizio:
  Le orme corrono in ogni direzione. Se si opera con serietà: nessuna macchia. \e
  Si cerca di illuminare  una situazione confusa e controversa. 
  Capire in che direzione andare dipende da ciò che ci viene fornito da altri. 
  Bisogna avere la chiarezza interiore  per decifrare i messaggi impliciti, i segni che stanno alla base di questa vicenda. 
  Se si sapranno distinguere non vi saranno conseguenze.  
  Muta in 56 – Viandante ';
$book['30']['line2'] = 
' Sei al secondo posto: 
  Splendore giallo. Sublime salute. \e
  Si è nella perfezione della chiarezza, il cuore della luce e del bene. 
  Muta in 14-Possesso grande';
$book['30']['line3'] = 
' Nove al terzo posto: 
  ...
  Le tenebre si avvicinano, mentre la chiarezza vacilla. 
  Cercando di farsi forza ci si distrae in futili passatempi e ci si dispera per l’imminente declino. 
  Qualcosa volge al termine.  
  Muta in 21- Morso che spezza ';
$book['30']['line4'] = 
' Nove al quarto posto:
  Subitanea è la sua venuta; divampa, muore, viene buttato via.\e
  Un fuoco di paglia che brilla per un istante  ma non ha effetti duraturi. 
  Tutto ciò che si ottiene è una piccola e breve pausa prima che torni l’oscurità. 
  Muta in 22- Grazia ';
$book['30']['line5'] = 
 'Sei al quinto posto:
  Lacrime a fiumi, sospiri e lamenti. Salute! \e
  Pentimento amaro è talvolta utile. C’è da pentirsi su come si è agito, e si avranno rimpianti. 
  Eppure grazie a questa triste esperienza riusciremo a fare chiarezza nella situazione.  
  Muta in 13- Associazione';
$book['30']['line6'] = 
' Nove sopra:
  Il re lo adopera per spedizioni punitive. La miglior cosa è allora uccidere i capi e catturare i seguaci. Nessuna macchia.\e
  E’ necessario  operare in profondità, stabilendo una disciplina  che organizzi il disordine della vicenda; bisogna operare sui fondamenti e le basi della situazione, migliorandola ed emendandola dal guasto. 
  Allora saremo capaci di avere successo e un seguito. 
  Nessun danno, nessun vantaggio. 
  Muta in 55 – Abbondanza ';

# -------------------------      31       ----------------------- #
$book['31']['desc'] = 
' Esagramma 31 – La Stimolazione
  Il Lago sul Monte. La forza maschile si trova sotto l’influenza di quella femminile, da cui è attratto.  
  Vi è attrazione reciproca, desiderio di unirsi a chi  è affine o a qualcosa a cui si è legati. 
  Altro nome dell’esagramma è ‘La domanda di matrimonio’: un uomo corteggia una donna da cui è ispirato e arricchito.';
$book['31']['judge'] = 
' Riuscita. Propizia è perseveranza. Prendere una fanciulla in moglie reca salute. \e 
  Quando vi è un legame  di un qualche genere tra persone affini ne nasce attrazione, cioè si cerca di unirsi con l’altra. 
  Ma che tipo di attrazione è? Seduzione momentanea o profonda affinità?
  Nel secondo caso si presuppone un paziente corteggiamento che condurrà a una stabile unione. In questo caso vi è riuscita.';
$book['31']['image'] = 
' Sul monte vi è un lago. L’immagine della stimolazione. Così il nobile, essendo pronto ad accoglierli, fa sì che gli uomini gli si avvicinino.\e
  Il monte freddo e fermo viene bagnato dalle acque di un lago. 
  Ne nasce vita e fertilità, scambio, attrazione. 
  Così anche nel mondo umano si devono accogliere gli stimoli esterni che ci nutrono per avvicinarci a chi li fornisce. 
  Bisogna prepararsi ad accogliere segnali di avvicinamento con qualcuno o qualcosa che ci sta a cuore.';
$book['31']['line1'] = 
' Sei all\'inizio significa:
  La stimolazione si manifesta nell’alluce. \e
  Nulla di concreto ancora si manifesta, è appena un pensiero che spinge verso qualcosa o qualcuno, in modo inaspettato. 
  Muta in 49- Rivoluzione';
$book['31']['line2'] = 
' Sei al secondo posto significa:
  La stimolazione si manifesta nei polpacci. Sciagura! Indugiare reca salute. \e
  Si è spinti verso qualcosa  che seduce ma in modo superficiale limitato nel tempo. 
  Non c’è una decisa attrazione. 
  Prima di percorrere questa strada soppesate molto bene i pro e i contro. 
  Muta in 28 La Preponderanza del Grande';
$book['31']['line3'] = 
' Nove al terzo posto significa:
  La stimolazione si manifesta nelle cosce. Si attiene a ciò che segue. Continuare così è vergognoso.  \e
  Le cosce vanno dove va il pensiero. Se qualcuno manifesta il suo pensiero verso di noi, con parole o atti, ecco che subito ne nasce attrazione. 
  Ma si può mai cedere così ai capricci e gli impulsi di qualcun altro? 
  Questo atteggiamento è umiliante per noi, andrebbe modificato. 
  Muta in 45 Raccolta';
$book['31']['line4'] = 
' Nove al quarto posto significa:
  Perseveranza reca salute. Pentimento svanisce. \e
  Quando si pensa irrequieti a questo e a quello, allora si seguono soltanto gli amici ai quali si dirigono pensieri consapevoli. 
  Pensieri e preoccupazioni continuano ad assillarci, perchè la mente è catturata da troppe cose, non tutte chiare e rette. 
  Allora si si dovrebbero seguire solo le persone che ci corrispondono e con cui i rapporti sono chiari. 
  Continuando a fare così non vi sono cause di futuro rammarico.     
  Muta in 39 Difficoltà';
$book['31']['line5'] = 
' Nove al quinto posto significa:
  La stimolazione si manifesta nella nuca. Nessun pentimento. \e
  Quando due persone sono attratte lo sono soprattutto nel pensiero, da cui si espande a tutte le altre diramazioni dell’azione umana.  
  Non si va oltre il pensiero, quindi non ci sono motivi di rammarico.  
  Muta in 62 Preponderanza del Piccolo';
$book['31']['line6'] = 
' Sei sopra significa:
  La stimolazione si manifesta nelle mascelle, nelle guance e nella lingua. 
  Non c’è guadagno o perdita, solo si parla. 
  Si chiacchiera ma con discorsi superficiali. 
  Muta in 33  Ritirata.';
...
' Esagramma 32 : La Durata
  ...
  A volte ciò che dura è un ostacolo che condiziona la nostra vita; o una relazione che non si spegne, nonostante l’impossibilità di una evoluzione. 
  In amore ciò che dura e non cambia mai -né in positivo né in negativo- rischia di ristagnare e pian piano scomparire, trasformandosi in altro: amicizia, rimpianto, attesa, senso di vuoto.  
  Le difficoltà esterne non riescono ad arrivare a una soluzione naturale,  per cui occorre continuare il percorso per sciogliere un nodo karmico che ci condiziona e implica impegno  per risolversi in positivo. 
  ll matrimonio dura, il cielo, la terra e tutte le cose fondamentali durano. 
  Ciò che dura permane sempre, ciò che finisce non era sufficientemente saldo.';
$book['32']['judge'] = 
' Riuscita. Nessuna macchia. Propizia è perseveranza. Propizio è avere ove recarsi.\e
  La riuscita è data dal fatto che  nonostante si incontrino ostacoli la situazione di cui si chiede si evolve comunque, ma  né in bene né in male. 
  Si affrontano alti e bassi in molteplici esperienze che si ripetono. 
  Vi è qualcosa da fare, iniziative da prendere per favorire l’impresa che ci sta a cuore.  
  Le cose si evolvono se si agisce, a lungo e in profondità: ci vuole tempo. 
  Ogni linea dell’Esagramma racconta un modo in cui la situazione può durare, e se vi è costanza. 
  Costanza significa fedeltà allo scopo, volontà di superare gli ostacoli, capacità di  resistere per progredire attraverso ogni  prova.';
$book['32']['image'] = 
' Immagine Tuono e vento, l’immagine della durata. Così il nobile sta saldo e non muta direzione.\e
  Il vento è costante, il tuono si muove fortemente: in natura sono sempre congiunti e si rafforzano l’un l’altro.  
  In questa situazione si resta costanti e saldi anche nelle avversità.';
$book['32']['line1'] = 
' Sei all\'inizio significa:
  Volere troppo presto durata reca costantemente sciagura. Nulla che sia propizio.\e
  Situazione negativa. Ciò che ci sta a cuore è prematuro e se agiamo per conseguire questo risultato le cose andranno male. 
  Non è il momento adatto per iniziare alcunché. 
  Qui ci sono illusorie fantasie, fantasmi della mente desideri che non si realizzano. 
  Muta in 34 Potenza del grande';
$book['32']['line2'] = 
' Nove al secondo posto significa:
  Svanisce pentimento. \e
  Si ha rispondenza positiva, un piccolo successo. 
  Le cose si mettono al meglio.
  Nonostante tutto, c’è motivo di essere ottimisti.  
  Muta in 62 Preponderanza del piccolo';
$book['32']['line3'] = 
' Nove al terzo posto significa:
  Chi non conferisce durata al suo carattere va incontro a ignominia. Costante umiliazione.\e
  Si è indecisi, combattuti, dubbiosi. 
  La situazione sembra volersi sbloccare in avanti, ma vi sono  continui ripensamenti. 
  Questa fragilità nelle intenzioni è già di per sé foriera di ulteriori frustrazioni. 
  Anche esternamente, a causa di tale indecisione di fondo, vi è sviluppo negativo. 
  Muta in 40 Liberazione';
$book['32']['line4'] = 
' Nove al quarto posto significa:
  Nel campo non vi è selvaggina. \e
  Si cerca nel posto sbagliato: non c’è nulla da fare qui se non qualcosa che hai già inutilmente percorso. 
  Muta in 46 Ascesa';
$book['32']['line5'] = 
' Sei al quinto posto significa:
  Conferire al proprio carattere durata per perseveranza; ciò è salute per una donna, sciagura per un uomo. 
  La situazione richiede pazienza e sopportazione, ma il peso e l’impegno, se si è donne, alla fine daranno frutto. 
  Una donna che testardamente e con passione continua a credere in un compito. 
  Un uomo è implicato, ma lui non è all’altezza e non riesce a perdurare. 
  Molto male per lui.  
  Muta in 28 Preponderanza del grande';
$book['32']['line6'] = 
' Sei sopra significa:
  Irrequietezza come stato durevole reca sciagura. \e
  Il massimo dell’incostanza. 
  Nessun punto fermo. 
  Muta in 50 Crogiolo';
...
';
$book['33']['judge'] = 
'Riuscita. Nel piccolo è propizia perseveranza.\e
 L’oscurità avanza, l’attività deve ritirarsi da essa.  
 La situazione è in pausa e non si sviluppa oltre. 
 E’ bene allontanarsi e non farsi coinvolgere da ciò che è inamovibile  e fermo, preservando le forze. 
 Bisogna agire solo in cose marginali, in una lunga e paziente attesa. 
 Consolidare ciò che si ha, lavorare nel piccolo, riorganizzare: questa è una pausa costruttiva';
$book['33']['image'] = 
' Sotto il cielo c’è il monte: l’immagine della ritirata.  Così il nobile tiene lontano l’ignobile, non irato, ma pacato.\e
  Il monte si arresta e non può arrivare fino al cielo. 
  Qualità del monte è la tranquillità, ed è con essa che bisogna agire in questa situazione. 
  Bisogna ritirarsi e voltare le spalle a qualcosa di volgare e basso, ma senza bruschi strappi, senza risentimento e rabbia ma con tranquilla riservatezza. 
  Ci sono piccoli aggiustamenti da fare, per proteggersi da ciò che irrisolto e non chiaro. 
  Non bisogna affrontare a muso duro ciò che è ignobile  con drastiche decisioni, ma con serenità allontanarsi da ciò che causa disturbo.';
$book['33']['line1'] = 
' Sei all\'inizio significa:
  In coda durante la ritirata: ciò è pericoloso.   Non bisogna voler imprendere qualche cosa. \e
  In un tempo in cui bisogna ritirarsi e cedere il posto, si cerca invece  di resistere e attardarsi; non è il momento di agire. 
  Muta  in 13 Associazione';
$book['33']['line2'] = 
' Sei al secondo posto significa:
  Egli lo vincola con giallo cuoio di bue. Nessuno è in grado di strapparlo. \e
  Ci si dovrebbe ritirare ma si è costretti a restare per risolvere alcuni nodi. 
  Si è legati dall’idea di avanzare, mentre sarebbe opportuno ritirarsi. 
  Ci sono insormontabili impedimenti, dettagli importanti che impediscono la risoluzione. 
  Muta in 44 Farsi incontro';
$book['33']['line3'] = 
' Nove al terzo posto significa:
  Ritirata interrotta è penosa e pericolosa. Tenere la gente come servi e serve reca salute. \e
  La situazione che ci sta di fronte è già abbastanza distante e ferma e si vogliono ulteriormente tagliare i ponti in modo definitivo.  
  Ne conseguono  pericolo e turbamenti. 
  Sono coinvolte persone che possono esserci utili, anche se sono modeste e di poco conto.
  Muta in 12 Ristagno';
$book['33']['line4'] = 
' Nove al quarto posto significa:
  Ritirata volontaria reca salute al nobile, decadimento dell’ignobile.\e
  La decisione di fermarsi è giusta e comporta il distacco naturale da ciò che è difficile e oscuro.
  Esso pian piano si allontana nel posto che gli compete, più in basso e lontano da noi. 
  Muta in 53  Progresso graduale ';
$book['33']['line5'] = 
' Nove al quinto posto significa:
  Ritirata amichevole. Perseveranza reca salute.\e
  Non si operano tagli drastici ma un gentile e penetrante allontanamento da ciò che causa disagio. 
  Assecondare questo movimento è salutare. 
  Muta in 56 Viandante.';
$book['33']['line6'] = 
' Nove sopra significa:
  Ritirata serena. Tutto è propizio.\e
  Nessun dubbio è possibile all’apice del cielo. 
  Ci si ritira serenamente e la distanza dagli ostacoli è completa. 
  Muta in 31 Stimolazione';

# -------------------------      34       ----------------------- #
$book['34']['desc'] = 
' Esagramma 34 – La Potenza del Grande.
  Il Cielo sotto e il Tuono sopra. 
  Forza e Movimento insieme producono  un grande potere e proprio per questo è necessario trattenere e domare le spinte a strafare. 
  Solo in questa circostanza il Potere è tale e vi è ordine; ma quando la forza non è controllata diventa aggressività, caratterizzata da illusorie speranze e paure che cercano di manipolare gli altri, e allora l’ordine viene perduto.
  Talvolta persone e eventi entrano nella nostra vita condizionandoci a reagire, con risultati spesso deludenti. 
  Se riponiamo speranze in qualcosa o qualcuno, sta a noi comprendere se la situazione può essere nutrita affinché cresca. 
  In caso contrario ciò che è  promettente e  gratificante, finisce per nascondere insidie.
  Bisogna comprendere il pericolo, spesso ben nascosto tra le pieghe dell’autocompiacimento arrogante e vanitoso che ci porta a strafare; ancorarsi invece ad un solo scopo, avere una meta, credere profondamente e con passione in un’idea, per costruirla e renderla possibile concretamente  ci rende capaci di  concentrare la volontà di fare in una sola direzione, senza disperdere le forze in attività distraenti.';
$book['34']['judge'] = 
'  La potenza del grande. Propizia è perseveranza.\e
   Il grande è il Cielo che nella sua attività è accompagnato dalla rettitudine e dalla luce. 
   Abbiamo il potere di creare le cose e forgiarle nel modo più giusto e ordinato. 
   Deviare utilizzando le nostre forze per intraprendere altre attività ci distrae dal nostro scopo. 
   Bisogna insistere su questa strada.';
$book['34']['image'] = 
'  Il tuono sta in alto nel cielo: l’immagine della potenza del grande. \e
   Così il nobile non percorre sentieri che non corrispondono all’ordine. 
   La Forza Creativa denota una situazione di  positività; tutto si predispone al meglio, ma c’è pericolo di strafare e di eccedere se non si definisce bene la direzione da prendere. 
   Evitate i colpi di testa, restate chiari e fermi nell’ agire per il meglio, nel vostro interesse, senza scendere a compromessi con persone – o situazioni- ambigue che vi si avvicinano.';
$book['34']['line1'] = 
' Nove all\'inizio significa:
  Potenza nelle dita dei piedi. Sciagura.Qesto è certamente vero. \e
  La volontà  è circoscritta ai primi passi in questa impresa e si esaurisce alla prima resistenza. 
  Ci si vuole avviare in situazioni che nascondono difficoltà e intoppi. 
  Non se ne ricava assolutamente niente di buono. 
  Muta in 32 Durata';
$book['34']['line2'] = 
' Nove al secondo posto significa:
  Perseveranza reca salute. \e
  Azione positiva e potere creativo sono ora in pieno sviluppo. 
  Avanzare con decisione in questo momento è favorevole. 
  Muta in 55- Abbondanza';
$book['34']['line3'] = 
' Nove al terzo posto significa:
  L’ignobile agisce mediante la potenza, il nobile non agisce così. Continuare è pericoloso. Un capro cozza contro una siepe e si impiglia le corna.\e
  Non si può agire facendo di tutta l’erba un fascio, con forza cieca. 
  Siamo come un capro (simbolo di Tui, trigramma interno) che stolidamente vuole distruggere qualcosa che di per sé non è offensivo, e coì facendo finisce per mettersi in una situazione di pericolo. 
  Meglio non farlo.  
  Muta in 54 Ragazza che si sposa';
$book['34']['line4'] = 
' Nove al quarto posto significa:
  Perseveranza reca salute. Pentimento svanisce. La siepe si apre, non vi è nessun groviglio.\e
  La potenza poggia sull’asse di un grande carro. 
  Un equivoco si scioglie e nascono opportunità di crescita che portano beneficio. 
  Non occorre far nulla, esternamente le cose vengono condizionate proprio dalla nostra immobilità. 
  Muta in 11  Pace';
$book['34']['line5'] = 
' Sei al quinto posto significa:
  Perde il capro ma non se ne rammarica. Nessun pentimento. \e
  Si incontrano  vecchie abitudini che non sono più adatte al livello cui si è giunti. 
  Esse sono inconsistenti e improduttive. 
  Ma ora si può lasciarle cadere e proseguire per la propria strada. 
  Muta in 43 Risolutezza';
$book['34']['line6'] = 
' Sei sopra significa:
  Un capro cozza contro una siepe. Non può andare né indietro né avanti. Nulla è propizio. 
  Se ci si accorge della difficoltà, questo reca salute. 
  Ancora stolidamente si agisce a testa bassa e senza ragionare. 
  La situazione ci spinge nelle difficoltà e a tutto scapito nostro. 
  Ma c’è la possibilità di tirarsi indietro prima che le cose si complichino e salvarsi da altri problemi.  
  Bisogna tirarsi indietro prima che siamo troppo coinvolti in qualcosa di disgregante per il nostro cammino. 
  Muta in 14 Possesso grande';
...
' Esagramma 35 : Il Progresso
  ...
  Sapremo sostenere la situazione mettendo in campo le nostre competenze e risorse. 
  I nostri meriti e le nostre ragioni vengono riconosciuti.Un nuovo ciclo giunge, foriero di soddisfazione. 
  L’esagramma è l’opposto dell‘Occultamento della luce, 36, in cui nessuno sa nulla di chi siamo veramente. 
  ‘Il soggetto di questo esagramma è qualcuno che nella sua ascesa attraversa vicissitudini di ogni sorta e il testo indica come deve comportarsi. 
  (C G Jung)’';
$book['35']['judge'] = 
' Progresso. Il forte principe viene onorato con una moltitudine di cavalli. In un giorno è ricevuto tre volte.\e
  La linea forte al quarto posto avanza deciso tra ombre e inerzie, come fa una persona che attraversa tante dure prove senza vantarsene con nessuno  e poi, alla fine, viene riconosciuto il suo valore. 
  In premio  avrà non solo il riconoscimento delle sue capacità, ma anche modo di metterle in pratica. 
  Si preannunciano tempi faticosi ma costruttivi e molti contatti con altri, anche di grado superiore al nostro.';
$book['35']['image'] = 
' Il sole sta sulla terra:il progresso.
  Il nobile rende splendenti le sue chiare virtù. La terra segue il sole, avanzando verso di lui, quindi progredendo. 
  Così le virtù finora nascoste vengono  portate alla luce, e finalmente danno frutto.';
$book['35']['line1'] = 
' Sei all\'inizio significa:
  Procede, ma viene respinto. 
  Perseveranza reca salute. 
  Non incontrando fiducia si rimanga pacati. Nessun errore. 
  La nostra aspirazione per ora è infruttuosa, i tentativi di miglioramento che  proponiamo e vorremmo fare non vengono accolti. 
  Bisogna insistere, non avvilirsi, cercare di superare l’esasperazione del momento, mantenere la calma.  
  Facendo così non si compiono errori.  
  Muta in 21 Morso che spezza';
$book['35']['line2'] = 
' Sei al secondo posto significa:
  Procede, ma con mestizia. Perseveranza reca salute. Si ottiene poi grande fortuna dalla propria antenata. \e
  Si vuole andare avanti ma il cuore è pesante; ciò che si lascia indietro è difficile da dimenticare. 
  Ma è meglio insistere e andare avanti, per favorire il processo di crescita. 
  Poi, arriva l’intervento di una donna conosciuta nel passato, che aiuta a superare questo periodo incerto. 
  Muta in 64 – Prima del compimento';
$book['35']['line3'] = 
' Sei al terzo posto significa:
  Tutti sono d’accordo. Il pentimento svanisce. \e
  La linea forma il trigramma interno Fuoco e sta sotto il Fuoco esterno: il Sole sorge due volte e inizia un nuovo giorno; le cause di preoccupazioni scompaiono, da entrambe le parti si pensa e si agisce alla stessa maniera.  
  Corrispondenza e affinità di pensiero e azione.  
  Muta in 56 Viandante.';
$book['35']['line4'] = 
' Nove al quarto posto significa:
  Progresso come un criceto. Perseveranza reca pericolo.\e 
  La situazione va avanti a piccoli passi incerti. 
  Forzare le cose in questa direzione non è un bene per noi.  
  Muta in 23 Frantumazione';
$book['35']['line5'] = 
' Sei al quinto posto significa:
  Pentimento svanisce. Non prenderti a cuore guadagno o perdita. Imprese  recano salute. Tutto è propizio.\e
  Le cause di preoccupazione scompaiono, le esperienze che si compiono non conducono né a guadagno né a perdita; essi sono secondari, ma anche se non ci sono tornaconti non importa. Si gira pagina. 
  Comincia un nuovo progetto in cui credere, ci sono le condizioni perché tutto vada bene.  
  Muta in 12 Ristagno. ';
$book['35']['line6'] = 
' Nove sopra significa:
  Progredire con le corna è lecito soltanto per punire il proprio territorio. 
  Coscienza del pericolo reca salute. Nessuna macchia. Perseveranza reca umiliazione. \e
  Vogliamo andare a testa bassa verso qualcuno che non appartiene alla nostra cerchia più vicina. 
  Questa azione sarebbe giusta solo se fosse diretta verso chi ci è affine. 
  Ma qui non è così. 
  Se si insiste a voler arrivare oltre ciò che è lecito ne subiremo tristi conseguenze. 
  Muta in 16 Fervore ';
...
' Esagramma 36 : L’Occultamento della luce.
  ...
  Contrapporsi apertamente per contrastarlo porta a mescolarsi con esso e dargli forza  e perdere così la via, danneggiando ciò che è sano e integro.  
  La luce, la nostra luce, si ritira per sfuggire alla tenebra incipiente e così passare inosservata.
  Occultamento della luce significa ferita. 
  Difendersi dall’oscurità e i suoi legami, schermarsi, proteggersi, mettere un muro per poter crescere senza disturbo: così una ferita guarisce se ci si cura e ci si allontana dalla fonte di contagio; così un ostacolo si dissolve se non ci si espone alla sua influenza, venendo a patti con esso. 
  Tentando di convincere e domare ciò che non può essere reso docile,  si finisce divorati e sminuiti.';
$book['36']['judge'] = 
' L’ottenebramento della luce. Propizio essere perseveranti nelle avversità.
  Bisogna rimandare i progetti per diventare più forti degli ostacoli, ora presenti in modo pervasivo. 
  Ostacolo che si presenta come fattore interno – difficoltà a comprendersi e a relazionarsi, fatica nel connettersi allo stesso livello ricettivo…Nessuno sforzo è abbastanza grande quando ci si trova a livelli così diversi e ciò che si desidera è tanto distante da ciò che si può fare.  
  Persino  ritirare il consenso e il supporto a qualcuno ora non è un atto egoistico; tale ritiro è necessario per preservare la propria identità: attualmente non ci sono rispondenze esterne per rafforzarla e il nutrimento deve essere cercato all’interno di sé.
  Se lo si cerca altrove – dando vita alle solite speranze e timori-  si preferisce il compromesso, lasciandosi sedurre dalle solite fantasie egocentriche, che a lungo andare ci si ritorcono contro…L’esagramma esorta a non cedere al compromesso e ad accrescere e temprare le forze interiori. 
  Nel frattempo, diventiamo selettivi. 
  Per evitare di essere feriti e perdere la via è necessario  nascondere ciò che si sta diventando agli altri, il che  è uno dei cardini dell’esperienza interna più elevata. 
  E’ una sorta di isolamento creativo in cui si preparano nuovi comportamenti che hanno bisogno del loro tempo per stabilizzarsi. 
  Interagire apertamente con l’esterno ora conduce ad equivoci e ostacoli seri.';
$book['36']['image'] = 
' La luce si è immersa nella terra: l’immagine dell’ottenebramento della luce. 
  Così il nobile vive con la grande moltitudine, egli vela il suo splendore e rimane pur chiaro.

  Non si è forti abbastanza per la condivisione e per creare relazioni autentiche. 
  Nulla di ciò di cui ora hai bisogno – sostegno, comprensione, fiducia – viene restituito; il valore di ciò che offri è anzi sminuito ed è incompreso. Meglio allora non dare niente, e splendere solo per se stessi, in attesa di altri tempi. 
  Lascia che il tuo fuoco bruci nel silenzio e nella solitudine, rafforzando il tuo reale scopo. 
  Non bisogna vivere questo momento come una diminuzione o un’impossibilità: il ritiro qui è una scelta strategica e deliberata, da assecondare teneramente e senza biasimo.  
  Occorre armarsi di volontà inflessibile davanti alla predominanza dell’oscurità e decidere un distacco da tutto ciò – e da chi-  ti ha deluso, ingiuriato e ferito, in attesa che l’ombra si dissolva da sé, senza il tuo intervento';
$book['36']['line1'] = 
' Nove all\'inizio significa:
  Ottenebramento della luce in volo. 
  Egli abbassa le sue ali. Il nobile durante la sua peregrinazione non mangia nulla per tre giorni. Ma egli ha dove recarsi.\e
  L’oste ha occasione di sparlare di lui. Si cerca di trovare rispondenza e si è pieni di entusiasmo. 
  Poi però avete occasione di rendervi conto che le cose sono diverse da ciò che vi aspettavate.
  Nel cercare la soluzione  vagate, impegnandovi a fondo nella ricerca.
  State credendo in qualcosa che sembra arricchirvi ma poi  si rivela modestamente interessante. 
  Il desiderio del vostro cuore viene deluso e sminuito, e inoltre qualcuno non è d’accordo con voi e vi critica di nascosto. 
  Il vostro scopo può fare a meno del contributo marginale di queste persone. 
  Muta in 15 Modestia ';
$book['36']['line2'] = 
' Sei al secondo posto significa:
  L’ottenebramento della luce lo ferisce alla coscia sinistra. 
  Egli porta aiuto col vigore di un cavallo. Salute. \e
  L’impresa è impedita, ostacolata e difficoltosa ad esprimersi; la vostra luce è sminuita ma nonostante questo se vi mettete in gioco e vi impegnate segue salute. 
  Muta in 11 Pace';
$book['36']['line3'] = 
' Nove al terzo posto significa:
  L’ottenebramento della luce durante la caccia nel Meridione. Si cattura il grande capo. Non si può arrivare in fretta alla perseveranza. \e
  I tuoi tentativi di migliorare la situazione sono dettati dalla volontà di fare pulizia e rimettere ordine nel passato. E’ proprio dal passato che ritorna qualcuno, il principale artefice del tempo oscuro che stai vivendo. 
  Il suo impatto sulla situazione è così negativo che non si può sperare di sradicarlo per sempre e con continuità.
  Si sta andando verso chi ha potere disgregante per il nostro cammino e che ostacola continuamente il nostro andare. 
  Muta in 24 Ritorno';
$book['36']['line4'] = 
' Sei al quarto posto significa:
  Egli penetra nella cavità addominale sinistra. Si ottiene il cuore dell’ottenebramento della luce e si abbandonano porta e cortile. \e
  Il vostro agire vi porta vicinissimi all’oscurità e al pericolo e in questo modo si riescono a smascherare le sue vere intenzioni. 
  L’ambiguità della  situazione è insostenibile e ci si allontana subito da lui. 
  Muta in 55 Abbondanza';
$book['36']['line5'] = 
' Sei al quinto posto significa:
  Ottenebramento della luce come per il principe Chi. Propizia è perseveranza.\e
  Il principe Chi era legato dalla sua posizione di responsabilità a restare accanto al sanguinario tiranno Chu Hsin. 
  Non potendo allontanarsi si finse pazzo. Fingi, o sii diplomatico. Cela a tutti le tue intenzioni. 
  La situazione  è causa di malessere e sofferenza, ma bisogna sopportarla se si vuole raggiungere ciò che vogliamo. 
  Muta in 63 Dopo il compimento';
$book['36']['line6'] = 
' Sei sopra significa:
  Non luce, bensì tenebre. Prima ascese al cielo, poi precipitò negli abissi della terra.\e
  Si è raggiunta una posizione influente ma non è per molto; si è perso di vista in giusto cammino, percorrendo sentieri che non corrispondono all’ordine e non consentono ulteriore sviluppo. 
  Ben presto questa via si esaurisce e si spegne. 
  Muta in 22 Grazia';
...
' Esagramma 37 : La Casata
  ...
  Perché la situazione funzioni tutto dipende dalla donna e dalla sua capacità di far fronte al suo senso di responsabilità verso la sua cerchia più vicina e di mantenere un giusto contatto con loro. 
  Qui ogni linea assume le sembianze di un membro della famiglia. ';
$book['37']['judge'] = 
' La casata. Propizia è la perseveranza della donna.
  In una famiglia tutti hanno un ruolo prestabilito  e  in questa situazione l’elemento femminile, per  natura incerto e mutevole,  potrebbe esplorare altre vie, ma si sforza di ritornare al suo posto, dove è giusto che sia e rimanga.
  Essa mostra costanza e verità nel suo ruolo, evitando di farsi prendere la mano da attività che la distolgono dal suo scopo primario. 
  Il trigramma interno Kan Abisso indica un pericolo che viene evitato grazie alla chiarezza del Fuoco: bisogna essere fedeli al proprio ruolo senza farsene distogliere, cercando la verità e seguendo le più intime convinzioni, quelle giuste che ci riconnettono a ciò che sappiamo e possiamo fare. 
  Le nostre debolezze e le difficoltà sono man mano rischiarate e dissolte da chiarezza e comprensione su chi siamo e del nostro posto nell’ ordine  delle cose;  insistendo su questa strada vi sarà beneficio.';
$book['37']['image'] = 
' Il vento scaturisce dal fuoco: l’immagine della casata. 
  Così il nobile è coerente nelle sue parole e costante nelle sue azioni.\e
  Il vento  penetra dovunque, il fuoco è coerente e costante. 
  Entrambi tendono verso l’alto e ad evolversi, a patto che si abbia la capacità di essere costanti e mantenere fede alla parola data.';
$book['37']['line1'] = 
' Nove all\'inizio significa:
  Salda chiusura all’interno della casata. Il pentimento svanisce. \e
  Il figlio. La linea chiude in basso il trigramma fuoco affinché non si disperda.
  Chiudete saldamente le porte ad attività dispersive. 
  Restate al sicuro e non andate fuori strada altrimenti ve ne pentirete. 
  Muta in 53 Progresso graduale';
$book['37']['line2'] = 
' Sei al secondo posto significa:
  Ella non deve seguire il suo capriccio. Deve provvedere all’interno per il cibo. Perseveranza reca salute. \e
  La linea yin è instabile e capricciosa, è la moglie. 
  Il suo posto è all’interno ma vorrebbe venir meno ai suoi doveri, seguendo vane avventure. 
  Ci sono altri che dipendono da noi, per necessità essenziali che solo noi possiamo soddisfare. 
  Dobbiamo dedicare il nostro tempo a loro. 
  Muta in 9 Forza domatrice del piccolo';
$book['37']['line3'] = 
' Nove al terzo posto significa:
  Quando nella casata la gente si accalora nasce pentimento per troppa severità. Cionostante, salute!\e
  Quando la donna e i bambini si trastullano e ridono ciò conduce infine all’umiliazione. 
  La linea, il fratello, è forte tra due deboli ma di transizione e all’inizio e fine del semisegno Fuoco e centro dell’Acqua: troppo calore genera emotività e contrasti ed è facile allora che sorgano amarezze e risentimenti. 
  Avete subito dure lezioni, che pensate di non meritare; ma ciò vi ha anche permesso di maturare e crescere, e di progredire. 
  Ma se ora si continua ad allontanarsi dalle proprie responsabilità, a non prendere sul serio il proprio ruolo, facendo comunella con qualcuno più giovane e ingenuo allora non si  risolverà nulla e se ne soffrirà nel tempo. 
  Muta in 42  Accrescimento';
$book['37']['line4'] = 
' Sei al quarto posto significa:
  Ella è la dovizia della casa. Grande salute! \e
  La linea è yin, la moglie del fratello, e  si trova tra due forti, un posto che assolutamente le compete, da cui grande salute.  
  Si tratta di una persona che sa qual è il suo posto, che è l’anima della casa, è capace di portarla avanti e farla prosperare e crescere, senza però precluderle scambi con l’esterno. 
  Muta in 13 Associazione ';
$book['37']['line5'] = 
' Nove al quinto posto significa:
  Un re si avvicina alla propria casata. Non temete. Salute! \e
  E’ il marito della donna capricciosa al secondo posto. 
  C’è  qualcuno a cui dare le nostre cure e il nostro rispetto. 
  Non temete questa decisione, è un passo che porterà ordine nella vostra vita. 
  Muta in 22 Grazia.';
$book['37']['line6'] = 
' Nove sopra significa:
  Il suo lavoro impone rispetto. Alla fine viene salute. 
  E’ il padre della casata, il capo indiscusso in ogni circostanza.
  Ciò che avete creato e costruito nella vostra vita  vi ha reso una persona da stimare e rispettare.
  Qualcuno mette in dubbio il vostro valore e la vostra competenza ma avrà modo di ricredersi. 
  Muta in 63 Dopo il compimento';

# -------------------------      38       ----------------------- #
$book['38']['desc'] = 
' Esagramma 38 – La Contrapposizione
  Lago sotto e Fuoco sopra: polarità discordanti per natura tendono a separarsi. 
  Fino a che le cose sono tenute ferme non ci sono problemi, ma quando si comincia ad agire la natura contrapposta degli elementi diverge. 
  Nascono allora i tentativi di riconciliare una situazione di allontanamento.';
$book['38']['judge'] = 
' La contrapposizione. In piccole cose riuscita.
  Malintesi e incomprensioni generano  allontanamento tra le parti coinvolte. 
  Si vorrebbe rimediare ma gli interessi di fondo sono discordanti; 
  riuscita solo in faccende marginali che non risolvono la distanza e la lontananza tra le parti.';
$book['38']['image'] = 
' Acqua e fuoco, l’immagine della contrapposizione. Anche stando in compagnia, il nobile mantiene intatta la sua individualità.  \e
  Due nature sono estranee  e lontane l’una dall’altra e in qualche modo tendono a volersi avvicinare. 
  Si vorrebbe un accordo comune, si fanno tentativi di collaborare  e riuscire, ma la differenza è sostanziale. 
  Anche se si è vicini a qualcuno è una vicinanza momentanea e superficiale.';
$book['38']['line1'] = 
' Nove all\'inizio significa:
  Il pentimento svanisce. Se smarrisci il cavallo non lo rincorrere; ritorna da sé. \e
  Quando vedi gente cattiva guardati da errori. Separazione  e perdita.
  Qualunque sia la causa di allontanamento e divisione non è il caso di preoccuparsi eccessivamente: se non si interviene ciò che è perduto tornerà spontaneamente; quando ciò avverrà ci si accorge che ciò che ritorna non è più al nostro stesso livello ricettivo e potrebbe causare errori e disturbi. Occorre vigilare e mantenersi indipendenti.
  Muta in 64, Prima del Compimento.';
$book['38']['line2'] = 
' Nove al secondo posto significa:
  Si incontra il proprio signore in uno stretto vicolo. Nessuna macchia.\e
  Anche se vi è affinità un incontro aperto e chiaro è impossibile. 
  Bisogna adattarsi a circostanze difficoltose e di portata marginale che non hanno però la forza e l’energia per un’evoluzione della situazione. 
  Muta in 21, Il morso che spezza';
$book['38']['line3'] = 
' Sei al terzo posto significa:
  Si vede il carro trascinato indietro, i buoi tenuti fermi, l’uomo con capelli e naso recisi. \e
  Non un buon inizio, ma una buona fine. Si torna indietro, invischiati in faccende già percorse in passato e  che non si sviluppano.
  Qualcuno che non ha cuore il nostro bene ne è l’artefice. 
  La situazione non progredisce, anzi sembra peggiorare. 
  Poi, grazie alla comparsa di una forte motivazione, si riesce a liberarsi da queste pastoie. 
  Nonostante tutto si trova un modo per uscire da questo brutto empasse.
  Muta in 14 Possesso Grande';
$book['38']['line4'] = 
' Nove al quarto posto significa:
  Isolati per contrapposizione si incontra un uomo dai sentimenti affini, col quale si possono avere rapporti di fedeltà. 
  Nonostante il pericolo nessuna macchia. 
  Nonostante i nostri tentativi di avvicinamento, si rimane soli. 
  Ecco che allora arriva qualcuno di cui possiamo fidarci ciecamente che ci salva dal pericolo di insistere in qualcosa che continua a tormentarci.
  Muta in 41 Diminuzione';
$book['38']['line5'] = 
' Sei al quinto posto significa:
  Il pentimento svanisce. Il compagno si fa strada coi denti attraverso l’involucro. \e
  Andare da lui, come potrebbe questo essere un errore? 
  Quando si è isolati si tende a considerare tutti come nemici e ostili. Ma le cause di tristezza scompaiono. 
  C’è un ritorno di qualcuno con la nostra stessa indole e sta cercando di superare le divisioni. 
  A questo atto di buona volontà bisogna rispondere positivamente. 
  Non si deve rifiutare questa opportunità. Muta  in 10 Procedere';
$book['38']['line6'] = 
' Nove sopra significa:
  Isolato per contrapposizione si vede il proprio compagno come un porco carico di sudiciume, come un carro pieno di diavoli. \e
  Prima si tende l’arco contro di lui, poi si ripone l’arco. 
  Non è un predone, egli vuol promettersi a tempo debito.
  Andandovi cade pioggia, poi viene salute! Pregiudizi e sospetti infondati tengono lontano chi si ha bisogno di toccare e avere accanto.
  Deporre le armi e affrontare la situazione risolvendo il conflitto. 
  Vi sono perdite, ma c’è qualcuno che ha bisogno del nostro contatto e della nostra presenza. 
  Incontro positivo dopo difficoltà e allontanamento. Muta in 54 Ragazza che si sposa';

# -------------------------      39       ----------------------- #
$book['39']['desc'] = 
' Esagramma 39 – L’Impedimento.
  Sotto c’è il Monte, che induce a fermarsi, sopra c’è l’Abisso, il pericolo. 
  Bisogna fermarsi e cambiare strada, quella che vorremo percorrere è pericolosa.
  A volte abbiamo aspirazioni che sembrano una buona idea. Ma andare avanti significa rompersi la testa contro un muro. 
  Un muro che nonostante tutto quello che si è fatto finora, è sempre lì. 
  Non lo hai ancora attraversato. Colpa degli altri? Non se continui a percorrere strade che conducono a disgreganti incontri con l’Ombra, così seducente con i suoi richiami allettanti; ma che alla lunga non danno il frutto sperato. 
  L’antica immagine evoca  uno zoppo con le stampelle in una casa con due coperte perché si gela. 
  Una visione di tempi grami, in cui avversità e ostacoli sono pervasivi. 
  Le  difficoltà sorgono quando ci si ostina a cercare nel posto sbagliato e nel modo sbagliato. 
  Invece di volare alto, si va zoppicando qua e là, cercando nuovi inizi, desiderando di più di ciò che si ha.
  E così facendo, ci si allontana da se stessi e dalla propria integrità interiore. 
  Un Sé mutevole è un centro oscillante la cui azione ha sempre i semi del fallimento. 
  Credi in te stesso, dà più valore a ciò che sei. 
  Ambisci a scopi più alti, in cui accettare di non proseguire oltre significa tornare indietro a qualcosa di buono, di caldo e supportivo. 
  Per ora resta lì, non cercare condivisione davanti.';
$book['39']['judge'] = 
' L’Impedimento. Propizio è il sud ovest. Non è propizio il nord est. Propizio è vedere il grande uomo. La perseveranza è salutare.\e
  Un pericolo ci sta davanti. Il sud ovest è il paese degli amici, il nord ovest dei nemici. 
  Tornare a ciò che ci dà calore e benessere e ha continuità,  invece che andarsi a cacciare nelle fauci dei nemici dove le vie finiscono è un chiaro avvertimento a non proseguire. 
  Non ci sono le condizioni perché le cose vadano in porto.
...
$book['39']['line1'] = 
' Sei all\'inizio significa:
  Andare conduce impedimenti, venire incontra lode. \e
  Se si prosegue si avvicinano molte difficoltà e pericoli. 
  Meglio voltare le spalle a questa impresa.
  Muta in 63 Dopo il Compimento';
$book['39']['line2'] = 
' Sei al secondo posto significa:
  Il servitore del re trova impedimento su impedimento. Ma non è colpa sua.\e
  Qualcuno o qualcosa  a cui teniamo ci mette in difficoltà. 
  Si è in buona fede, ma questa via è completamente irta di ostacoli. 
  Ci si trova coinvolti in una situazione difficile causata da qualcun altro. 
  Muta in 48 il Pozzo';
$book['39']['line3'] = 
' Nove al terzo posto significa:
  Andare conduce ad impedimenti; ed ecco che egli ritorna.\e
  Andare avanti significa buttarsi nel pericolo, di cui ci siamo già accorti: si torna indietro, verso chi ci è affine. 
  Muta in 8 Unione';
$book['39']['line4'] = 
' Sei al quarto posto significa:
  Andare conduce a impedimenti, venire conduce ad unione. \e
  Se si va  avanti si resta da soli ad affrontare ostacoli che non possiamo superare; bisogna fermarsi e raccogliersi attorno a persone di cui si ha fiducia. 
  Muta in 31 La Stimolazione';
$book['39']['line5'] = 
' Nove al quinto posto significa:
  In mezzo ai massimi impedimenti vengono amici. \e
  Ci si trova nel mezzo del pericolo e non si può sfuggirgli. 
  Ma in mezzo al pericolo  si avvicina qualcuno o qualcosa che ci appoggia e sostiene. 
  La situazione non è completamente svantaggiosa. 
  Muta in 15 Modestia';
$book['39']['line6'] = 
' Sei sopra significa:
  Andare conduce a impedimenti, venire conduce a grande salute. Propizio è vedere il grande uomo. \e
  Se si prosegue si va incontro a ostilità e problemi, occorre tornare dove si è partiti. 
  Là c’è sviluppo e progresso, e qualcuno che può ben consigliarci e sostenerci. 
  Muta in 53  Progresso Graduale';
...
$book['40']['judge'] = 
' La liberazione. Propizio è il sud ovest. Quando non vi è più luogo ove doversi recare, il ritorno è salutare. \e
  Se vi è ancora un luogo ove si debba andare, allora è salutare la rapidità. 
  Ci si trova in una situazione di pericolo da cui è consigliabile uscire. 
  Il sud ovest è il luogo dove c’è la moltitudine, quindi dove si trovano gli altri ed è bene che vi incamminiate per quella strada. 
  Dirimete ogni pendenza e portate a termine la vostra questione, poi dimenticate e perdonate, tornando alla vita ordinaria. Agite velocemente.';
$book['40']['image'] = 
' Tuono e pioggia arrivano: l’immagine della liberazione. Così il nobile perdona gli errori e rimette le colpe.\e
  Tuono e pioggia alludono alla natura che viene irrorata da una pioggia vivificante, che libera l’aria dai miasmi di presenze disturbanti.  
  La pioggia lava via gli errori e le colpe vostre e di altri coinvolti; quando è tempo di tensione o crisi molte sono le cose assurde che si compiono. Perdonate, liberatevi della passata oscurità e alleggerite il vostro cammino.';
$book['40']['line1'] = 
' Sei all\'inizio significa:
  Senza macchia. La crisi sta finendo, anche se ancora vecchi disturbi si mantengono vivi. Lascia andare il passato, con i suoi tristi ricordi e volgiti al nuovo corso che puoi dare alla situazione.  
  Muta in 54-Ragazza che si sposa';
$book['40']['line2'] = 
' Nove al secondo posto significa:
  Nel campo si abbattono tre volpi e si riceve una freccia gialla. \e
  Perseveranza è salutare. Si fa pulizia. Il pericolo e le ambiguità presenti vengono illuminate e scoperte, quindi abbattute.
  Rimuovete il pericolo che vi minaccia con perseveranza e a lungo.
  Muta in 16- Fervore';
$book['40']['line3'] = 
' Sei al terzo posto significa:
  Quando uno porta un carico sulla schiena e ciò nonostante va sul carro egli invoglia così i briganti ad avvicinarsi. Perseveranza conduce ad umiliazione.\e
  La linea è debole ma sta in mezzo ai trigrammi interni Acqua, pericolo e briganti; la linea si trova in difficoltà, cerca di allontanarsi dal pericolo ma la sua posizione già precaria vorrebbe avvantaggiarsi proprio di ciò che rappresenta il pericolo. 
  Quando si  è già carichi di problemi, aggiungerne altri è veramente assurdo. 
  Insistere su questa strada produce solo danno. 
  Muta in  32 Durata';
$book['40']['line4'] = 
' Nove al quarto posto significa:
  Devi liberarti del tuo alluce. Allora il compagno si avvicina e di lui ti puoi fidare.\e
  Preparati a lasciare  qualcuno su cui hai fatto molto affidamento in passato. 
  Quando lo farai si avvicineranno coloro ai quali tieni di più, buoni compagni di cammino. 
  Muta in 7 Esercito';
$book['40']['line5'] = 
' Sei al quinto posto significa:
  Ma se il nobile può liberarsi ciò reca salute.Mostra così all’ignobile che egli fa sul serio.\e
  Quando ci si libera di chi è basso e inferiore, carico di colpe e gravi errori, molto c’è da guadagnare. 
  Occorre mostrare con fermezza che costoro non sono più graditi. 
  Così si ritirano, lasciando il campo libero.   
  Soltanto lasciandoti energicamente alle spalle ciò che ti ha messo in difficoltà nel passato puoi liberarti.  
  Muta in 47 Oppressione ';
$book['40']['line6'] = 
' Sei sopra significa:
  Il principe tira a uno sparviero su un alto muro. Egli lo abbatte. Tutto è propizio.\e
  Ancora un ultimo impedimento, uno sparviero, un malvagio altolocato si oppone alla liberazione. 
  Ma la forza del nostro cuore è tale da abbattere anche quest’ultimo ostacolo. 
  Tutto è favorevole. 
  Muta in 64 Prima del compimento';

# -------------------------      41       ----------------------- #
$book['41']['desc'] = 
' Esagramma 41 – La Diminuzione
  Sotto Tui, il lago: discorsi, parole, ogni tipo di scambio, serenità e fertilità. Sopra Ken il Monte, l’Arresto: fermare e arrestare, limitare e domare. L’acqua del lago evaporando diminuisce ma nello stesso tempo accresce le falde del monte, arricchendole di vita. Perdita e guadagno si bilanciano. 
  La struttura del segno ricorda una casa con solide fondamenta, che rendono stabile un alto edificio. 
  Anche nei rapporti umani c’è chi dà e chi riceve, e in alcuni casi, come questo, tutti ne traggono beneficio. 
  Così qualcuno cede qualcosa per andare incontro all’altro: questa è una situazione di mediazione tra il troppo e il poco, in cui il dare e ricevere, chi più chi meno, sono il fondamento del rapporto. ';
$book['41']['judge'] = 
' Diminuzione unita a veracità opera sublime riuscita senza macchia. Si può essere perseveranti nel farlo. Propizio è imprendere qualche cosa.
  Come si può riuscirvi? Si adoperino pure due ciotoline per il sacrificio.\e
  Occorre fare a meno qualcosa che non ci nutre più perché ostacola il nostro cammino. 
  E’ il momento di compiere questo passaggio e aprire nuove vie. 
  Lasciate andare le vane chiacchiere e siate onesti e sinceri. 
  Date il vostro contributo a chi ne ha bisogno, e non fategli mancare il vostro sostegno, anche materiale.  
  C’è qualcosa che ci viene a mancare, il cui allontanamento può procurarci un piccolo dolore, ma in cambio di questo sacrificio acquistiamo in semplicità, la cui presenza nella nostra vita apre le porte a lunghissima pace.
  Ciò che è sacrificato non è di grande portata: si tratta di un sacrificio modesto, quella parte di sé che ci si ostina a non voler abbandonare,  tenuta insieme da vecchie abitudini che l’esagramma ci invita a gettarci alle spalle. 
  Attraverso questo sincero atto di rinuncia  sorge spontaneo l’ottenimento e l’impresa che vi sta a cuore ha riuscita.';
$book['41']['image'] = 
'  Alle falde del monte sta il lago: l’immagine della diminuzione. 
   Così il nobile doma la sua ira e raffrena i suoi istinti. 
   Il Lago evapora e cala, e solo così facendo il monte e le sue falde si arricchiscono di vita. 
   Così è necessario lasciare da parte discorsi che istigano ad agire e che compromettono il nostro cammino: sono inutili e nocivi. 
   Trovate la calma necessaria per affrontare la situazione lasciando perdere biasimo e rimproveri, inutili per modificare l’ impresa che ci sta a cuore.';
$book['41']['line1'] = 
' Nove all\'inizio significa:
  Andare rapidamente quando gli impegni sono finiti non è una macchia. Ma bisogna ponderare quanto sia lecito diminuire gli altri.\e
  Quando si è portato a termine  un affare o un impegno non è sbagliato guardare avanti e proseguire.
  Vi sono però coinvolte altre persone che potrebbero interpretare il nostro agire come una sgarberia o un danno per loro. 
  Su questo occorre riflettere.
  Muta in 4- Meng Stoltezza giovanile. ';
$book['41']['line2'] = 
' Nove al secondo posto significa: 
  Propizia è perseveranza. Imprendere qualche cosa è sciagurato. Senza diminuire se stessi si è in grado di accrescere gli altri.\e
  La situazione va avanti senza interventi da parte nostra.  
  E’ sconsigliato agire o avviare un’attività: infatti, anche se non ci si mette in gioco in prima persona, e la propria intromissione nell’impresa è di secondo piano, (il trigramma inferiore Tui allude a discorsi e parole ), agli altri si fornisce comunque qualcosa che dà nutrimento. 
  Muta in 27- Nutrimento';
$book['41']['line3'] = 
' Sei al terzo posto significa:  
  Quando tre persone percorrono la stessa via diminuiscono di una persona. Quando il viandante è solo, trova il suo compagno. \e
  Questa linea, l’ultima di Tui, oscura, fa presente che nel progetto ci sono troppe persone coinvolte. 
  In tre sorgono facilmente divergenze di punti di vista e opinione, o gelosia, quindi almeno una di loro deve ritirarsi. 
  La situazione opportuna sarebbe quella di chi è solo e così può liberamente associarsi a qualcun altro che è al suo stesso livello. 
  Muta in 26 – La forza domatrice del grande';
$book['41']['line4'] = 
' Sei al quarto posto significa: 
  Diminuendo i propri difetti si fa sì che l’altro si affretti e abbia gioia. Nessuna macchia. \e
  Se si vuole che l’altro si avvicini occorre abbandonare atteggiamenti e prese di posizione un pò ambigue.  
  Se questi difetti vengono corretti  gli altri ne traggono giovamento per avanzare e ne sono arricchiti. 
  Per noi però non cambia molto. 
  Muta in 38- Contrapposizione';
$book['41']['line5'] = 
' Sei al quinto posto significa: 
  Certamente qualcuno lo accresce. Dieci coppie di tartarughe non possono opporsi a questo. Sublime salute! \e
  Qualunque sia il nostro agire, si riceve guadagno e fortuna. 
  In principio l’oracolo era effettuato con i gusci di tartaruga: se anche per dieci volte di seguito si chiedesse la stessa domanda l’esito sarebbe sempre lo stesso. 
  Si è favoriti e beneficiati dall’alto, quasi al di là di ciò che si fa o non si fa: la situazione è destinata a evolversi da sola.  
  Muta in 61- Verità Interiore';
$book['41']['line6'] = 
'Nove sopra significa:
 Se si viene accresciuti senza diminuire gli altri, questo non è una macchia. Perseveranza reca salute. Propizio è imprendere qualche cosa. \e
 Si ottengono dei servitori, ma non si possiede più una dimora particolare. 
 In questa situazione non vi è danno per nessuno, né per chi dà né per chi riceve.
 Questo disinteresse è tipico delle persone dotate di generosità e saggezza, ed è bene continuare in questo modo. 
 Tutto ciò che si fa e si intraprende, essendo disinteressato, procura amici e un seguito. 
 Si è molto lontani da uno scopo particolare o egoistico.  
 Muta in 19- Avvicinamento';
...
' Esagramma 42 : L\'Accrescimento
  ...
  L’esagramma esprime la relazione tra qualcuno che dà e qualcuno che riceve, tra qualcosa che viene lasciato e qualcosa che aumenta. 
  Il Tuono e il Vento sono rispettivamente l’Eccitante e il Mite, l’uno irruento, l’altro che si muove senza attaccarsi a nulla. 
  Entrambi perdono e acquistano, così che il nobile anche attraverso una piccola perdita può avere un grande guadagno.';
$book['42']['judge'] = 
' L’accrescimento. Propizio è imprendere qualche cosa. Propizio attraversare la grande acqua. \e
  Miglioramento e aumento. E’ un momento in cui ciò che è grande e chiaro supera ciò che è debole e oscuro. 
  Si può agire e intraprendere anche azioni drastiche e decisive.';
$book['42']['image'] = 
' Immagine Vento e Tuono, l’immagine dell’accrescimento. Così il nobile: quando scorge un bene lo imita, se ha difetti se ne sbarazza.  
  Il vento corrisponde al principio oscuro, il tuono a quello chiaro.  
  Un’azione da intraprendere è positiva. Quando sono presente palesi difficoltà ed errori è opportuno allontanarsene.
  Bisogna correggere cattive abitudini nostre o di chi ci sta a cuore con fatti e azioni supportando l’emersione di comportamenti corretti e chiari. 
  E’ richiesta forza e impegno poichè l’impresa è difficile e richiede il nostro intervento risolutivo. 
  Si allontana ciò che è un peso, si va verso la guarigione.';
$book['42']['line1'] = 
' Nove all\'inizio significa:
  Propizio è compiere grandi gesta. Sublime salute! Nessuna macchia. \e
  Una situazione di difficoltà si può risolvere con un’azione decisa e accurata che spinge a progredire. Essa ha riuscita. 
  Per noi non c’è vantaggio ma neppure perdita.  
  Muta in 20- Contemplazione';
$book['42']['line2'] = 
' Sei al secondo posto significa:
  Certamente qualcuno lo accresce. Salute! \e
  Un evento o qualcuno dall’esterno viene a darci manforte nella situazione; ne consegue arricchimento e un aumento. 
  Muta in 61- Verità interiore';
$book['42']['line3'] = 
' Sei al terzo posto significa:
  Si è arricchiti da avvenimenti sciagurati. Nessuna macchia se sei verace e cammini nel mezzo e riferisci al principe con un sigillo. \e
  Si è in difficoltà a causa di incomprensioni che ci danneggiano. 
  Tuttavia si può rimediare spiegando le nostre ragioni con onestà e chiarendo sinceramente la nostra posizione a qualcuno  verso cui nutriamo fiducia. 
  Si rimedia facendosi avanti e spiegandoci meglio. 
  Muta in 37- Casata';
$book['42']['line4'] = 
' Sei al quarto posto significa:
  Se cammini nel mezzo e riferisci al principe, egli seguirà. 
  Propizio è il trasferimento della capitale.\e
  Occorre una certa moderazione, senza portare alle estreme conseguenze. 
  Devi fare un compromesso, perché nella situazione è presente qualcosa di importante che si può sviluppare.
  Se qualcuno vi chiede di cambiare e spostarvi, accettate. 
  Muta in 25- Innocenza';
$book['42']['line5'] = 
' Nove al quinto posto significa:
  Se in verità hai buon cuore non chiedere. Sublime salute! In verità la bontà sarà riconosciuta come tua virtù. \e
  Si attenda fiduciosi, il tempo ripagherà ampiamente questa dignitosa attesa senza che si debbano dimostrare apertamente le proprie giuste ragioni. 
  I nostri meriti sono infine riconosciuti. 
  Muta in 27- Nutrimento';
$book['42']['line6'] = 
' Nove sopra significa:
  Egli non porta accrescimento. Certamente qualcuno lo percuote. Egli non tiene fermo durevolmente il suo cuore. Sciagura!\e
  Non vi è guadagno anzi, subiamo una perdita.
  I rapporti non sono chiari e vi sono voltafaccia.
  Qui non si pensa ad altri che a se stessi e vi è grande volubilità.  
  Continuare su questa strada provoca grandi danni. 
  Muta in 3- Difficoltà iniziale';

# -------------------------      43       ----------------------- #
$book['43']['desc'] = 
' Esagramma 43 – Lo Straripamento
  C’è Tui, Lago, mentre sotto c’è il Cielo . L’acqua sale al cielo e sottoforma di pioggia si riversa  sulla terra,  distruggendo gli argini. 
  La situazione descrive il rilascio di una tensione a lungo trattenuta. 
  La struttura del segno allude a un momento in cui il male, rappresentato dalla sesta linea yin, viene  messo alle strette da tutte le linee yang. 
  Nei rapporti umani ciò significa che è presente qualcuno o qualcosa a cui opporsi chiaramente e senza scendere a compromessi.';
$book['43']['judge'] = 
' Lo straripamento. Con risolutezza bisogna render nota la cosa alla corte del re. Secondo verità si deve proclamarla. Pericolo! 
  Bisogna avvisare la propria città. Non è propizio impugnare le armi. Propizio è imprendere qualche cosa.\e
  Gli argini sono stati superati, i limiti oltrepassati; la situazione è allarmante e prima che sfugga di mano completamente bisogna prendere provvedimenti, spiegando a chi ha l’autorità le condizioni di disagio generale in cui ci si trova. 
  Si dichiarano in modo imparziale e oggettivo le difficoltà; esse sono pericolose  per il benessere di tutti coloro con cui si opera. 
  La reazione deve essere energica ma non di risentimento o rabbia; solo così si  avvia una strategia risolutiva per rimuovere l’ostacolo.';
$book['43']['image'] = 
' Il lago è asceso al cielo: l’immagine dello straripamento. 
  Così il nobile elargisce ricchezza verso il basso e rifugge dal riposare sulla sua virtù.\e
  Il Lago evapora e dà luogo alla pioggia torrenziale che fa tracimare i fiumi.
  Nello stesso modo chi è generoso e altruista non teme di mettersi in condizioni di svantaggio pur di salvaguardare il benessere altrui. 
  Si agisce spontaneamente nell’interesse degli altri esponendosi in prima persona.';
$book['43']['line1'] = 
' Nove all\'inizio significa: 
  Potente nelle dita dei piedi che avanzano. 
  Nell’andare senza essere all’altezza del compito si commette un errore. \e
  Ci si avvia baldanzosi delle proprie forze, ma il risultato potrebbe  deludere. 
  La linea incontra resistenza a salire, pur avendo impazienza e volontà di muoversi. 
  Ma il compito è al di là delle forze che si possiedono. Meglio non agire così. 
  Muta in 28 – Preponderanza del Grande.';
$book['43']['line2'] = 
' Nove al secondo posto significa: 
  Allarme. Di sera e di notte armi. Non temere nulla. \e
  Si è circondati da difficoltà e nemici. Ma se si prende atto che la situazione è oggettivamente pericolosa, tutto andrà bene e ne usciremo. 
  Muta in 49- Rivoluzione';
$book['43']['line3'] = 
' Nove al terzo posto significa: 
  Essere potenti negli zigomi reca sciagura. Il nobile è fermamente deciso. Egli cammina solitario e incorre nella pioggia. Egli viene spruzzato e si mormora contro di lui. Nessuna macchia. \e
  Non parlate troppo, confidando ad altri e recriminando sulla vostra situazione. 
  Agite in silenzio e sopportate da soli il biasimo di altri anche mentre le difficoltà aumentano. 
  Nonostante ciò andate avanti e fate ciò che dovete, anche a costo di diventare, per un certo periodo, impopolari. 
  Muta in 58 – Il Sereno';
$book['43']['line4'] = 
' Nove al quarto posto significa:
  Sulle cosce non vi è pelle, e il camminare riesce gravoso. Se ci si lasciasse condurre come una pecora il pentimento svanirebbe. \e
  Ma quando si udranno queste parole non si crederà ad esse.
  La situazione ha difficoltà a muoversi. Eppure sarebbe facile cedere a tutte le richieste che ci vengono fatte, seguendo docilmente gli eventi. 
  Anche se qualcuno ci parla con sincerità non siamo propensi ad ascoltarlo. 
  Muta in 5- Attesa';
$book['43']['line5'] = 
' Nove al quinto posto significa:
  Di fronte alle erbacce occorre forte risolutezza. Chi cammina nel mezzo rimane libero da macchia.\e 
  La malerba ricresce se non si sradica completamente. Pulizia. 
  Muta in 34- La Potenza del Grande';
$book['43']['line6'] = 
' Sei sopra significa: 
  Nessun richiamo! Alla fine viene sciagura. Si finisce in solitudine. \e
  Siamo rimasti soli e non abbiamo rispondenza da nessuno.  
  Muta in 1 – Creativo ';

# -------------------------      44       ----------------------- #
$book['44']['desc'] = 
'  Esagramma 44 – Il Farsi Incontro (La Tentazione)
   Sotto il cielo c’è il vento, che penetra dovunque persistendo. 
   La linea debole tiene in scacco tutte le linee forti, il cui compito dovrebbe essere di frenare l’insinuarsi dei pericoli che vengono dal basso.
   La linea yin ha però un potere magnetico e di attrazione verso i cinque yang, che facilmente si lasciano ammaliare dalla lunatica oscurità incipiente. 
   Si descrive una situazione in cui torna a rifare la sua comparsa una tentazione ammaliatrice e pertanto carica di ambiguità.';
$book['44']['judge'] = 
' Il farsi incontro. La ragazza è potente. Non bisogna sposare una ragazza simile.
  Qualcuno o qualcosa si avvicina e ha il potere di sconvolgere la nostra organizzazione di vita. 
  Voltate le spalle a questa tentazione, che comunque non sarà durevole.';
$book['44']['image'] = 
' Immagine Il Vento e il Cielo, l’immagine del farsi incontro. 
  Così  il principe  emana i suoi ordini e li proclama alle quattro regioni del mondo.
  Il Cielo e il vento si incontrano, così come qualcuno che ha l’occasione giusta per prendere le sue decisioni e ristabilire l’ordine in ogni ambito della propria vita';
$book['44']['line1'] = 
' Sei all\'inizio significa:
  Bisogna frenarlo con ceppi di ferro. Perseveranza è salutare. Lasciando correre si subisce sciagura. Anche un porco magro ha l’attitudine a infuriarsi. \e
  Un carro, la linea yin, senza guida e meta: un freno deve essere messo, altrimenti si va avanti alla cieca. 
  Se in passato abbiamo ceduto e ci siamo fatti condurre, è ora di dire basta. Assecondare significa insistere in qualcosa di pericoloso, che si crede facile e irrilevante ma può diventare – se lo segui – tremendamente difficile da gestire. 
  E’ una situazione da non alimentare, anche se carica di lusinghe. 
  Imparare a dire ‘no’ alle tentazioni è un necessario gradino da compiere per individuare la propria identità. 
  Muta in 1 Creativo';
$book['44']['line2'] = 
' Nove al secondo posto significa:
  Nella vasca vi è un pesce. Nessuna macchia! Non propizio per gli ospiti. Qualcuno arriva, trattato con ogni riguardo.\e
  Per noi va bene, ma causa problemi ad altri con cui siamo in rapporto. 
  Muta in 33 Ritirata';
$book['44']['line3'] = 
' Nove al terzo posto significa:
  Sulle cosce non vi è pelle e il camminare riesce gravoso. Rimanendo memori del pericolo non si commettono gravi errori. \e
  La linea è attirata dall’oscurità inziale, ma riesce ad evitare il pericolo di andarle incontro per la vicinanza delle altre forti yang. 
  Tuttavia la situazione è ferma, a causa dell’indecisione e difficoltà. 
  Muta in 6 Lite';
$book['44']['line4'] = 
' Nove al quarto posto significa:
  Nella vasca non vi è alcun pesce. Da ciò insorge sciagura.\e
  Darsi pena per chi non ha interesse per te, credere di accudire una perla che non esiste ti aliena da te stesso, allontanandoti da altre esperienze ben più fertili e supportive. Rimuovi all’istante i viticci dell’attaccamento egoistico e doloroso. Muta in 57 Vento';
$book['44']['line5'] = 
' Nove al quinto posto significa:
  Un melone coperto con foglie di salice. Linee celate. Ed ecco che ci cade in sorte dal cielo. \e
  Il melone  ha un ottimo sapore ma marcisce facilmente, così per proteggerlo lo si avvolgeva in foglie di salice. 
  La situazione è delicata e per ora va messa in secondo piano; così, senza prendere decisioni affrettate, limitarsi a lavorare per farla esprimere pienamente. 
  Muta in 50 Crogiolo ';
$book['44']['line6'] = 
' Nove sopra significa:
  Egli si fa incontro con le sue corna. Umiliazione. Nessuna macchia. \e
  Siamo emotivamente coinvolti e ci lasciamo trascinare in facili entusiasmi, così vogliamo entrare a testa bassa in qualcosa di disgregante. 
  Meglio alleggerire i pesi a cui ci si sta sottoponendo e riflettere meglio sul da farsi.  
  Muta in 28 Preponderanza del grande';
...
' Esagramma 45 : La Raccolta 
  ...
  Vi è qui  l’accenno alla figura del Grande Uomo a cui rivolgersi, figura che compare sempre in IChing quando il karma, o l’inconscio, hanno ancora in serbo parecchi elementi sconosciuti ancora immaturi e al di là della nostra comprensione. 
  La Terra accoglie l’acqua in sé in ogni caso, nella sua naturale recettività, seguendo gli eventi nel loro svolgersi. 
  Nel mondo umano ci si dispone ad accogliere gli eventi che man mano sorgono, cercando sempre di viverli in modo che diano frutto. 
...
' Raccolta. Riuscita. Il re  si avvicina al suo tempio. Propizio è vedere il grande uomo. Ciò reca riuscita. Propizia è perseveranza. Offrire grandi sacrifici reca salute. Propizio è imprendere qualche cosa.  \e
  Ci si avvicina al conseguimento di un importante risultato. 
  Vi sono molti aspetti nella situazione di cui dobbiamo ancora capire e sperimentare la natura; tali avvenimenti possono essere compresi solo man mano che emergono, interpretandoli con saggezza e discernimento. 
...
$book['45']['image'] = 
' Il Lago è al di sopra della Terra: l’immagine della raccolta. 
  Così il nobile prepara le sue armi per fronteggiare gli imprevisti. 
  L’acqua del lago si è raccolta in una  cavità del terreno.  
  L’acqua è mobile e indefinita nei suoi aspetti negativi, e come tale imprevedibile; nel mondo umano straripamento e siccità sono i pericoli imprevisti da cui guardarsi sempre. Si affrontano dunque fatti incerti e sconosciuti prima di risolvere l’evento in questione. 
  Bisogna armarsi, prepararsi a una serie di fatti a venire attualmente non ancora in vista e di cui nulla ancora sappiamo.';
$book['45']['line1'] = 
' Sei all\'inizio significa:
  Se sei verace, ma non sino alla fine, ora vi è scompiglio, ora la raccolta. 
  Se chiami, una mano amica porterà gioia. Non preoccuparti. Procedi.  
  ...
  Data la sua presenza, essa deve mettersi in marcia, malgrado le incertezze e le preoccupazioni dell’impresa. 
  Alla fine vi sarà possibilità di unirsi e connettersi con l’altro, persona o situazione, a cui si tende. 
  Muta in 17, Il Seguire. ';
$book['45']['line2'] = 
' Sei al secondo posto signifa:
  Lasciarsi tirare reca salute e si rimane senza macchia. 
  Se sei verace è bene compiere un sacrificio. 
  Quando si è indecisi si deve  sempre seguire ciò che ci è affine, anche se comporta cedere qualcosa per ottenerlo. 
  Muta in 47 Esaurimento. ';
$book['45']['line3'] = 
' Sei al terzo posto significa: 
  Raccolta con sospiri. Nulla che sia propizio. Andare è senza macchia, piccola umiliazione.\e
  La transizione tra volontà di seguire e le acque sfuggenti del lago determina una situazione di faticosa attesa. 
  Non ci si è ancora uniti al proprio simile e si tende sempre ad esso. Si deve sopportare una situazione difficile, cercando di adattarsi; questo atteggiamento porta umiliazioni e profondo disagio ma è un passo che purtroppo va compiuto.  
  Muta in 31- La Stimolazione ';
$book['45']['line4'] = 
' Nove al quarto posto significa: 
  Grande salute! Nessuna macchia.\e 
  La linea yin si riunisce finalmente con l’amico del quarto posto. 
  Chiarezza, sincerità nel dirsi e generosità nel darsi conducono finalmente a unione. 
  Muta in 8- Solidarietà';
$book['45']['line5'] = 
' Nove al quinto posto significa: 
  ...
  Si è indecisi se andare o restare, prendere o lasciare. 
  In realtà si ha la forza di restare e gestire bene la situazione, anche se di questo non ci si sente molto convinti.
  Essendoci altri coinvolti, bisogna anche tener conto che si tentenna anche da parte loro. 
  In questa situazione l’unione resta tale solo se almeno uno dei due mostra perseveranza e pazienza.
  Se lo si fa, allora non vi saranno cause di futuro rammarico.  
  Muta in 16- Il Fervore ';
$book['45']['line6'] = 
' Sei sopra significa: 
  Lamenti e sospiri, lacrime a fiumi. Nessuna macchia. \e
  La linea yin è fuori dall’influenza yang e tende ad allontanarsi. 
  La sua natura di seguire è mutata. 
  Si interrompe il contatto, si resta da soli a rimpiangere l’unione e l’occasione mancata. 
  Muta in 12- Ristagno.';
...
' Esagramma 46 : L\'Ascendere.
  ...
  Infatti è solo con il tempo che la radice che cresce nel buio  impara a superare le circostanze avverse e ad aggirare gli ostacoli.
  Bisogna tener presente che ciò che ascende non torna indietro, e che innalzarsi verso la luce significa anche lasciare indietro ciò o chi non serve più in termini di bisogno essenziale.';
$book['46']['judge'] = 
' L’ascendere ha sublime riuscita. Bisogna vedere il grande uomo. Non aver paura! Avviarsi verso il Meridione reca salute.\e
  Si riuscirà ad avanzare nell’impresa. 
  Dalla oscurità  alla luce, il passaggio non è repentino: non vi è distacco netto da qualcosa ma un lento sviluppo in positivo. 
  In questo difficile passaggio  è indispensabile ancorarsi  a qualcosa o qualcuno che ci sostenga e ci aiuti nelle scelte da fare, riguardo a  cose da lasciarsi alle spalle; non temete queste scelte perché al posto dell’oscurità potrete contare verso chi vi apprezza e vi è amico. 
  Andate verso chi vi accoglie a braccia aperte, anche se vi può sembrare di seconda scelta.';
$book['46']['image'] = 
' In mezzo alla terra cresce il legno: l’immagine dell’ascendere. Così il nobile, pieno di dedizione accumula piccole cose fino a creare elevatezza e grandezza.\e
...
$book['46']['line1'] = 
' Sei all\'inizio significa:
  Ascendere che incontra fiducia reca grande salute. \e
  Il desiderio di innalzarsi e di compiere ciò che ci sta a cuore si può realizzare e bisogna crederci. 
  Sollevarsi però si basa soprattutto sull’incontro con altri  che corrispondono  e favoriscono il nostro desiderio. 
  Vi è un reciproco desiderio di contatto e di incontro, quindi le nostre aspirazioni si possono realizzare. 
  Muta in 11 Pace';
$book['46']['line2'] = 
' Nove al secondo posto significa:
   Se si è veraci è propizio anche offrire un piccolo sacrificio. Nessuna macchia.\e
   Se si è convinti di voler realizzare il nostro scopo  occorre abbandonare anche qualcosa, rinunciare a un qualche beneficio presente. 
   Per noi non ne risulta né guadagno né perdita. 
   Muta in 15 Modestia';
$book['46']['line3'] = 
' Nove al terzo posto significa:
  Ascendendo si penetra in una città deserta. Cercando di realizzare il nostro scopo si va incontro a solitudine e isolamento. \e
  Esternamente non ci sono segni visibili di una qualche fortuna. 
  Vi è sì un movimento ma con scarsi risultati. 
  Muta in 7 Esercito';
$book['46']['line4'] = 
' Sei al quarto posto significa:
  Il re lo presenta al monte Chi. Salute. Nessuna macchia.\e
  Con l’aiuto di una persona influente si viene introdotti in una nuova situazione, ricca di buone opportunità. Né perdita né guadagno, si è indecisi. 
  Muta in 32 Durata';
$book['46']['line5'] = 
' Sei al quinto posto significa:
  Perseveranza reca salute. Si ascende per gradi.\e
  Senza fretta, passo dopo passo, quello che si vuole ottenere richiede pazienza e autodisciplina. 
  Non ci sono risultati immediati ma un lento progredire.
  Muta in 48 Pozzo';
$book['46']['line6'] = 
' Sei sopra significa:
  Ascendere nel buio. Propizio è essere incessantemente perseveranti.\e
  E’ un salto nel vuoto. Andare da questa parte è come mettersi in una situazione incerta di cui con conosciamo i contorni.
  Meglio attenersi a ciò che è certo e sicuro e insistere su quello.
  Bisogna cercare di capire fino a dove ci si può spingere e dove è più realistico fermarsi.  
  Muta in 18 Emendamento delle cose guaste';

# -------------------------      47       ----------------------- #
$book['47']['desc'] = 
' Esagramma 47 – L\'Oppressione.
  Acqua sotto il Lago.  
...
' Esagramma 48- Il Pozzo.
  ...
  Allora ci rifugiamo in un angolino e smettiamo di abbeverarci, ci limitiamo a covare il disappunto, a rimuginare sulle cose accadute, a rimpiangere. 
  In questo modo ci allontaniamo dal Pozzo. 
  Le cose ci accadono per una ragione: qualcosa finisce o ci spaventa o ci turba perché dobbiamo imparare a non esserene più turbati, spaventati o essere distrutti dal senso di perdita. 
  Spesso queste sensazioni tornano ciclicamente nella nostra vita perchè non impariamo nulla;tornano costanti nel tempo, ogni volta perdiamo l’occasione di imparare la lezione, in quel meccanismo che è la coazione a ripetere un’esperienza fino al suo completo dissolvimento e integrazione. 
  L’Ombra che affrontiamo in queste occasioni è l’Ombra più scura, che chiede di essere vista, affrontata e finalmente riconosciuta; capire questo è la prospettiva giusta per continuare a dissetarci; altrimenti perdiamo tempo e risorse, inariditi e fermi come morti, sicuri solo che abbiamo sofferto, soffriamo ora e soffriremo sempre. 
  Questa limitazione è la causa dell’inaridimento e del senso di blocco che viviamo. 
  Quando qualcosa o qualcuno ci impartisce una lezione di questo genere, dobbiamo imparare a accettarla come una grande ricchezza. 
  L’enorme potenziale dell’emozione coinvolta non è qualcosa che va dimenticato, rifiutato e accantonato; più è grande il dolore implicato nella situazione più dobbiamo essere capaci di vedere la nostra capacità di crescita. 
  Abbiamo attirato nella nostra vita proprio le persone e le situazioni terrificanti che ci servono. 
  Piccole cose mediocri sono per i mediocri. Grandi cose esaltanti, pur nella loro terribile forza, sono per grandi personalità. 
  Questa è la certezza che proviene dall’esagramma.
  C’è chi vive senza mai imparare nulla, subendo i colpi della vita come una vittima. 
  C’è invece chi porta avanti in solitudne e con indomabile forza il nutrimento di sé, cosciente che questi bocconi amari sono in realtà ciò che fa di noi dei leader, perché consentono saggezza e un discernimento che pochi possono raggiungere. 
  Il Pozzo è la Vita stessa, accettata come percorso che muta, cambia, accresce, fluida e vigorosa. 
  Sta a noi seguirla e berne l’elisir o versare inutili lacrime e limitarci a recriminare.Solo in questa prospettiva seguirà il successo. 
  In caso contrario, del Pozzo berremo solo il fango e non l’acqua limpida.  
  Vento sotto l’acqua, la  costante  e vicendevole penetrazione del legno e dell’acqua  rendono  fertili le situazioni. 
  Ci si disseta a qualcosa che non cambia mai, e a cui continuiamo ad accostarci ed è il fondamentale impulso che ci guida; sia esso amore, dedizione a qualcosa o una meta, essa va perseguita mentre ci cimentiamo con le sue forme. 
  E’ la fonte del nutrimento a cui dobbiamo cercare sempre di tornare.';
$book['48']['judge'] = 
' Il pozzo. Si cambi pure città, ma non si può cambiare il pozzo. Non cala e non cresce. Essi vanno e vengono e attingono al pozzo. 
  Se si è quasi raggiunta l’acqua del pozzo ma non si è ancora sul fondo con la corda, oppure se si rompe la brocca, ciò reca sciagura.\e
  Ogni consorzio vivente si raggruppa intorno a una fonte primaria, l’acqua che disseta.
  Essa è sempre lì, che continua a dare a chi ne ha bisogno, generosa e preziosa. 
  Due sono i pericoli da evitare se si vuole continuare a dissetarsi: rimanere a guardare l’acqua del pozzo senza decidersi ad attingere, oppure rompere la brocca per disattenzione e distrazione. 
  Vi è un’idea centrale che per quanto si apportino modifiche, non cambia né sparisce. 
  Si è sempre sul punto di raggiungerla, ma sempre sorgono intoppi.   
  Per bere da quest’impresa bisogna essere costanti e decisi, dedicandosi a fondo ad apprendere modi e tempi per la sua crescita.';
$book['48']['image'] = 
' Sopra il legno vi è l’acqua, l’immagine del pozzo. Così il nobile anima il popolo durante il lavoro e lo esorta all’aiuto reciproco.
  Il legno e l’acqua unendosi tendono verso l’alto, come una pianta che cresce e assorbe il nutrimento.
  Continuare l’attività di crescita, stimolare e accudire la situazione, integrando il contributo degli altri senza percorrere vie solitarie; non è tempo di individualismi e soluzioni originali.';
$book['48']['line1'] = 
' Sei all\'inizio significa:
  Il fango del pozzo non viene bevuto. Gli animali non vanno a un pozzo vecchio. La situazione è vecchia e non disseta nessuno.\e 
  Si sprofonda in una sorta di autocompiacimento della propria bassezza. La situazione è disgregata e confusa e non permette alcun sviluppo. 
  Muta in 5 Attesa';
$book['48']['line2'] = 
' Nove al secondo posto significa:
  Nella brocca del pozzo si catturano i pesci. La brocca è spaccata e perde. \e
  Invece di raccogliere ciò che può dissetarci, pulito e puro, ci si ritrova con qualcosa di inutile. 
  L’acqua da cui vogliamo attingere è irraggiungibile. 
  Se vi è una possibilità di arricchimento e di crescita, essa viene perduta.  
  Muta in 39 Impedimento';
$book['48']['line3'] = 
' Nove al terzo posto significa:
  Il pozzo è ripulito, ma non se ne beve l’acqua. E’ questo che mi accora; perché vi si potrebbe attingere. Se il re fosse chiaro, si godrebbe insieme della felicità.\e
  Abbiamo fatto tutto il possibile per mettere ordine e rendere pulita l’impresa. 
  Nonostante dedizione e pazienza, ciò che vi è di buono e fruttifero viene mistificato o frainteso. 
  E’ un peccato perché potrebbe rappresentare una fonte di felicità. 
  Ma la cosa dipende dalla nostra controparte, esterna o interna che sia, ambigua e indecisa. 
  Muta in 29 Abissale';
$book['48']['line4'] = 
' Sei al quarto posto significa:
  L’interno del pozzo viene rivestito di pietra. Nessuna macchia. \e
  Si mette ordine, costruendo basi nuove e pulite per l’impresa che ci sta a cuore.   
  Muta in 28 Preponderanza del grande';
$book['48']['line5'] = 
' Nove al quinto posto significa:
  Nel pozzo vi è una sorgente limpida e fresca alla quale si può bere. \e
  Vi è un luogo dove possiamo sempre tonare, sicuri di trovare pace e ristoro. 
  Si sta tra le cose che rappresentano per noi una sorgente inesauribile di serenità. 
  Muta in 46 Ascesa';
$book['48']['line6'] = 
' Sei sopra significa:
  Si attinge al pozzo senza impedimento. Esso è fidato. Sublime salute! \e
  Tutti possono bere al pozzo, buoni e cattivi. 
  Il pozzo non fa distinzione e tutti sanno che lì possono dissetarsi. 
  Da qui nasce la fiducia in lui. 
  Fidiamoci di ciò che non può cambiare ed è sempre lì ad accoglierci e confortarci. 
  Esso è la fonte del nutrimento, che può trasformare e penetrare tutti gli aspetti ambigui della nostra vita. 
  Muta in 57 Vento';

# -------------------------      49       ----------------------- #
$book['49']['desc'] = 
' Esagramma 49 - Il Sovvertimento (La rivoluzione è creduta solo dopo)
  Ogni cosa a suo tempo, ma intanto si costruisce per cambiare. 
  L’esagramma parla di esperienze che sanciscono il passaggio a un nuovo ordine, maturo per manifestarsi e in  linea con i tempi che cambiano. 
  Sta crollando  il vecchio status quo, il suo tempo è scaduto, e quasi non ce ne accorgiamo, mentre si lavora con fiducia per costruire qualcosa di nuovo; e poi, nel tempo, quando sarà opportuno, ci si ritroverà su rinnovati e fertili terreni di crescita; i semi che si gettano ora germoglieranno rinnovati, consistenti, soprattutto diversi e con una qualità risanatrice. 
  Cosa che adesso ci manca.  Ma  dissociarsi dall’ordine precedente non avviene da un giorno all’altro, ora sta appena iniziando il processo. 
  Un nuovo panorama si prepara davanti a noi, molto diverso dalla precedente condizione. ';
$book['49']['judge'] = 
' Il sovvertimento: nel giorno stabilito incontrerai fiducia. Sublime riuscita. Propizio per perseveranza. Il pentimento svanisce.\e
  Agire e attendere il risultato a lungo termine, questo è lo spirito del sovvertimento. 
  Se non sapete come comportarvi con qualcuno, è probabile che dobbiate completamente cambiare prospettiva. 
  ...
  Dobbiamo essere capaci di supportare e nutrire tutto ciò che ci dissocia dal passato. 
  E’ una grande transizione. ';
$book['49']['image'] = 
' Nel lago vi è il fuoco: l’immagine del sovvertimento. Così il nobile mette ordine nel computo del tempo e rende chiare le stagioni.
  Nel lago, gioioso e connesso con discorsi e parole, il fuoco illumina e mette in chiaro direzioni scevre da vecchie ambiguità.
  Cose che si ripetono nel tempo con risultati deludenti esauriscono il loro corso. 
  Sgombrare la strada da tali macerie e operare per il nuovo. 
  ...
  Si avvia una trasformazione positiva di tutto ciò che nel passato angustiava ed era causa di sofferenza. 
  Abbiate fiducia: anche se non è ancora manifesto, un grande cambiamento è alle porte.
   ';
$book['49']['line1'] = 
' Nove all\'inizio: 
  Si viene avvolti nella pelle di una vacca gialla. \e
  Il tentativo di sovvertire lo status quo non riesce, i tempi non sono maturi. 
  Occorre attendere e rimandare senza però allontanarsi da questa idea. 
  Muta in 31, Stimolazione';
$book['49']['line2'] = 
' Sei al secondo posto:
  Nel giorno stabilito si può sovvertire. Incamminarsi reca salute. Nessuna macchia.\e
  E’ il momento di agire affinché il cambiamento abbia il suo inizio. 
  Muta in 43- Straripamento ';
$book['49']['line3'] = 
' Nove al terzo posto: 
  Incamminarsi reca sciagura . Perseveranza reca pericolo. Quando per tre volte sia annunciato il sovvertimento, si può ricorrervi.\e
  La volontà è debole, e non produce risultati convincenti, anche a causa di mancata rispondenza e riluttanza della persona o situazione coinvolte. 
  Occorre fermarsi. Quando le persone o la situazione coinvolte renderanno manifesta e inequivocabile per tre volte la volontà di cambiare allora si può agire con successo. 
  Muta in 17- Il seguire ';
$book['49']['line4'] = 
' Nove al quarto posto: 
  Il pentimento svanisce. Si incontra fiducia. Mutare l’ordinamento statale reca salute.\e
  Si può agire per cambiare le cose e introdurre elementi nuovi e costruttivi nella situazione. 
  E’ bene in questa fase apportare modifiche consistenti alla struttura organizzativa in cui ci trova, in modo da far posto al nuovo. 
  Muta in 63, Dopo il compimento ';
$book['49']['line5'] = 
' Nove al quinto: 
  Il grande uomo cambia come una tigre. Ancora prima di interrogare l’oracolo egli incontra fiducia. \e
  Si è raggiunta la forza e la tensione giusta per operare il cambiamento voluto.
  La mossa decisiva può risultare da un nostro radicale cambio di prospettiva, in tal caso un successo straordinario è alle porte.  
  Il nostro agire cambia il mondo e l’ordine delle cose se anche noi stessi cambiamo.  
  Muta in 55, Abbondanza';
$book['49']['line6'] = 
' Sei sopra: 
  ...
  Quando si vuole cambiare veramente lo si fa in modo radicale e profondo; solo quando le motivazioni sono deboli il cambiamento avviene in superficie, in apparenza. 
  La situazione per avere un cambiamento radicale e all’altezza delle nostre aspettative non può progredire ancora e incamminarci per nuove vie e imprese porta a disgrazia. 
  Quando invece si coltiva pazientemente il cambiamento sperato, quando si lavora con costanza e impegno su ciò che già si ha, vi è un sicuro progresso.  
  Muta in 13, Associazione';
...
' Esagramma 50- Il Crogiolo.
  ...
  Esso è connesso alla trasformazione delle esperienze compiute in qualcosa di benefico e risolutivo per la nostra vita.  
  Il lavoro può essere ora portato a compimento, dandoci la pienezza agognata.';
$book['50']['judge'] = 
' Sublime salute. Riuscita.\e
  Il Calderone è un simbolo alchemico potentissimo: in esso il cibo viene cotto e trasformato in nutrimento, condiviso con gli altri e dagli altri ci viene dato; le sue qualità sono abbondanza e generosità: nelle relazioni vi è un progresso in cui le vostre vere qualità vengono riconosciute. 
  Attesa prima di un importante successo. 
  Vi è  una fondamentale trasmutazione del vecchio in un nuovo corso produttivo.';
$book['50']['image'] = 
' Al di sopra del legno vi è il fuoco. L’immagine del crogiolo.\e
  Così il nobile assestando la posizione ne consolida il destino. 
  Legno che arde sotto un fuoco: quando il calore che esso genera perdura, si attiva la forza che trasforma le cose. 
  Si radicano e si manifestano sempre di più certezze interiori che sciolgono i nodi del destino. 
  Agire con costanza per migliorare';
$book['50']['line1'] = 
' Sei all\'inizio significa:
  Un crogiolo con le gambe rovesciate. Propizio per eliminare i grumi. Si prende una concubina nella speranza di un figlio. Nessuna macchia. \e
  La linea ha fretta di salire, ma è debole. Nulla di buono si prospetta. 
  Tuttavia la sua sbadataggine provoca il capovolgimento della situazione e ci si sbarazza di ciò che c’è di sbagliato.  
  Così anche se si fa qualcosa di insoddisfacente e goffo alla fine non se ne è danneggiati. 
  Muta in 14 Possesso grande';
$book['50']['line2'] = 
' Nove al secondo posto significa:
  Nel crogiolo vi è cibo. I miei compagni hanno invidia, ma non possono farmi nulla. Salute! \e
  Qualcuno potrebbe invidiare e avere da ridire su ciò che facciamo ma non osa dircelo. Si agisce giustamente e si provoca il risentimento di un altro, che però tace.  
  Muta in 56 Viandante';
$book['50']['line3'] = 
' Nove al terzo posto significa:
  Il manico del crogiolo è alterato. Si è impediti nel progredire. Il grasso del fagiano non viene mangiato. Quando poi cade la pioggia, allora il pentimento svanisce. Finalmente viene salute. \e
  Il manico del calderone è inutilizzabile e non lo si può spostare. 
  E’ un momento di pausa, in cui non si ha accesso  e non si ha soddisfazione. 
  Ciò che c’è di buono viene lasciato inutilizzato. 
  Però con la pioggia, (la linea è in cima al trigramma interno Tui, Lago, che significa discorsi e parole sincere) la situazione si sblocca. 
  Ci sono discorsi da fare e che possono chiarire e sbloccare la stasi:  allora le cause di passata tristezza spariscono. 
  Bisogna parlare con il cuore e sinceramente e si esce dal ristagno.  
  Muta in 64 Prima del compimento ';
$book['50']['line4'] = 
' Nove al quarto posto significa:
  Il crogiolo si rompe le gambe. Le vivande destinate al principe vengono rovesciate, e la figura ne rimane imbrattata. Sciagura!\e
  Ciò che era destinato a qualcuno che ci sta a cuore si rivela causa di vergogna per lui e sciagura per noi. 
  Un malinteso e un fraintendimento causato involontariamente da noi e dalle nostre  parole superficiali rendono la situazione pesante e difficile. 
  Non si è stati sufficientemente saldi, in questo lavoro. 
  Muta in 18 Emendamento delle cose guaste"';
$book['50']['line5'] = 
' Sei al quinto posto significa:
  Il crogiolo ha manici gialli, anelli d’oro. Propizia è perseveranza.\e
  Bisogna comportarsi in modo fermo e stabile e non cambiare sempre idea, e cercare di essere sinceramente utili, dedicarsi con il cuore a risolvere la situazione. 
  Persistendo in questo comportamento, tutto andrà a posto. 
  Muta in 44 Farsi incontro ';
$book['50']['line6'] = 
' Nove sopra significa:
  Il crogiolo ha anelli di giada. Grande salute! Nulla che non sia propizio.\e
  Ogni azione che si intraprende risolve per il meglio la situazione.  
  Muta in 32 Durata';

# -------------------------      51       ----------------------- #
$book['51']['desc'] = 
' Esagramma 51 – Lo Scuotimento
